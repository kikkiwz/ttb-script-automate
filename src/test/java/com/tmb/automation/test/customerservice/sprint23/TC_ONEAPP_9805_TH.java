...
public class TC_ONEAPP_9805_TH extends Base {
    ...
    public void TC_ONEAPP_8852_NDID_EN_DEREGISTER_SIT_00001() throws Exception {
        ...
        Assert.assertTrue(elTitlePopupDeregister.equals("คุณต้องการยกเลิกบริการ?"));
        Assert.assertTrue(elPopupDeregisterDetail.equals("หลังจากยกเลิกบริการแล้ว คุณสามารถกลับมาสมัครบริการ NDID ได้ตลอดเวลา กรุณากด “ยืนยัน” เพื่อยกเลิกบริการ"));
        Assert.assertTrue(elBtnConfirm.equals("ยืนยัน"));
        Assert.assertTrue(elBtnCancel.equals("ยกเลิก"));
    }
    ...
    public void TC_ONEAPP_8852_NDID_EN_DEREGISTER_SIT_00005() throws Exception {
        ...
        Assert.assertTrue(elTitleNDIDDeregister.equals("ยกเลิกบริการ NDID สำเร็จ"));
        Assert.assertTrue(elNDIDDeregisterDetail.equals("คุณสามารถสมัครบริการ NDID อีกครั้ง ได้ตลอดเวลา"));
        ...
        Assert.assertTrue(elBtnBackToMainMenu.equals("กลับหน้าบริการ"));
    ...
    public void TC_ONEAPP_8852_NDID_EN_DEREGISTER_SIT_00006() throws Exception {
        ...
        Assert.assertTrue(elTitleNDIDError.equals("คุณไม่สามารถยืนยันตัวตน ในรูปแบบดิจิทัลได้"));
        Assert.assertTrue(elNDIDErrorDetail.equals("คุณมีสมบัติไม่ครบถ้วนกรุณานำบัตรประชาชน ไปที่สาขาของธนาคาร พร้อมถ่ายภาพใบหน้า เพื่อสมัครใช้บริการยืนยันตัวตน"));
        Assert.assertTrue(elContactError.equals("หรือติดต่อ ทีทีบี คอนแทค เซ็นเตอร์ 1428"));
