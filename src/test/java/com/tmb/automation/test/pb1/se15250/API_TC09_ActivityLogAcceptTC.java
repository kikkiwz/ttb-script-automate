...
public class API_TC09_ActivityLogAcceptTC extends Base {
...
//ekYC Activity Log ----------------------------------------------------
		...
		String Input1 = "Step (2/16) : eKYC - Accept T&C";
		String Input2 = "Y / N";
		String Input3 = "Y / N";
		String Input4 = "Y / N";
		String Input5 = "1.0";
		...
		hmC1.put("tc_product", Input2);
		hmC1.put("tc_channel", Input3);
		hmC1.put("tc_biomatric", Input4);
		hmC1.put("tc_product_version", Input5);
		hmC1.put("tc_channel_version", Input6);
		hmC1.put("tc_biometric_version", Input7);
...
//Verify in ccweb ------------------------------------------------------------------
		...
		String Details1f = Details1[5];
		String Details1g = Details1[6];
		...
		System.out.println("-------Details1f-------- : " + Details1f);
		System.out.println("-------Details1g-------- : " + Details1g);
		Assert.assertEquals(Details1a, "Step (2/16) = "+Input1);
		Assert.assertEquals(Details1b, "T&C of Product = "+Input2);
		Assert.assertEquals(Details1c, "T&C of Channel = "+Input3);
		Assert.assertEquals(Details1d, "T&C of Biomatric = "+Input4);
		Assert.assertEquals(Details1e, "T&C of Product version = "+Input5);
		Assert.assertEquals(Details1f, "T&C of Channel version = "+Input6);
		Assert.assertEquals(Details1g, "T&C of Biomatric version = "+Input7);
