...
public class OneApp9780blockCard extends Base {
    ...
    public static void SoGooD() throws Exception, ParseException {
     ...
     // Click via PIN
        ...
        Thread.sleep(5000);
        driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//android.widget.FrameLayout[@content-desc=\"Black Diamond\"]/android.view.ViewGroup")));
        // get text
        System.out.println("Get Account ID");
        MobileElement accID = driver.findElement(By.xpath("//android.widget.TextView[@content-desc=\"476281XXXXXX0455\"]"));
        String getAccID = accID.getText();


        // Click Card image
        System.out.println("Click on Card image");
        MobileElement bl = driver.findElement(By.xpath("//android.widget.FrameLayout[@content-desc=\"Black Diamond\"]/android.view.ViewGroup"));
        Log.logger.debug(bl);
        bl.click();
        ...
        Boolean testCardDetail = cardDetail.isDisplayed();
        System.out.println("Test result card detail= " + testCardDetail);
        if (cardDetail.isDisplayed()) {
