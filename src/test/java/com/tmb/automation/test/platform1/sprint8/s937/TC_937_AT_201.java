...
public class TC_937_AT_201 extends Base {
...
//		hs.waitVisible(hs.swBtnHS_VerifyEmail);
		...
		hs.assertText(hs.fX(hs.swLbHS_ChangeEmail).getText(), map("Text3_TH"));
		hs.assertText(hs.fX(hs.swLbHS_ChangeEmail_Content).getText(), map("Text4_TH"));
		
//		hs.click(hs.swBtnHS_VerifyEmail);
		hs.click(hs.swBtnHS_ChangeEmail);
		VerifyEmailpage ver = new VerifyEmailpage(appiumDriver);
		hs.waitVisible(ver.swLbVerifyEmail_Title);
		hs.assertText(hs.fX(ver.swLbVerifyEmail_Title).getText(), map("Text5_TH"));
		hs.assertText(hs.fX(ver.swLbVerifyEmail_Description).getText(), map("Text6_TH"));
		hs.assertText(hs.fX(ver.swBtnVerifyEmail_VerifyEmail).getText(), map("Text7_TH"));
