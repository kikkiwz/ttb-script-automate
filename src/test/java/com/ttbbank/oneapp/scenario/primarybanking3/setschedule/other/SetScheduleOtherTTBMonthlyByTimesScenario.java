...
public class SetScheduleOtherTTBMonthlyByTimesScenario extends PrimaryBanking3Base {
    ...
    @Test(groups = "SetScheduleTransferOtherToOtherTTBAccountMonthlyByTimesScenario", priority = 1)
    ...
    @Test(groups = "SetScheduleTransferOtherToOtherTTBAccountMonthlyByTimesScenario", priority = 2)
    ...
    @Test(groups = "SetScheduleTransferOtherToOtherTTBAccountMonthlyByTimesScenario", priority = 3)
    ...
    @Test(groups = "SetScheduleTransferOtherToOtherTTBAccountMonthlyByTimesScenario", priority = 4)
    ...
    @Test(groups = "SetScheduleTransferOtherToOtherTTBAccountMonthlyByTimesScenario", priority = 5)
