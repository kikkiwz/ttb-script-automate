...
public class SetScheduleOtherTTBMonthlyByEndDateScenario extends PrimaryBanking3Base {
    ...
    @Test(groups = "SetScheduleTransferOtherToOtherTTBAccountMonthlyByEndDateScenario", priority = 1)
    ...
    @Test(groups = "SetScheduleTransferOtherToOtherTTBAccountMonthlyByEndDateScenario", priority = 2)
    ...
    @Test(groups = "SetScheduleTransferOtherToOtherTTBAccountMonthlyByEndDateScenario", priority = 3)
    ...
    @Test(groups = "SetScheduleTransferOtherToOtherTTBAccountMonthlyByEndDateScenario", priority = 4)
    ...
    @Test(groups = "SetScheduleTransferOtherToOtherTTBAccountMonthlyByEndDateScenario", priority = 5)
