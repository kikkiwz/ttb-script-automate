...
public class API_TC06_ActivityLogOpenAccount extends Base {
...
//ekYC Activity Log ----------------------------------------------------
		...
		String Input1 = "Step (16/16) : eKYC - Open Account Status";
		...
		hmC1.put("open_account_status", Input2);
...
//Verify in ccweb ------------------------------------------------------------------
		...
		Assert.assertEquals(Details1a, "Step (16/16) = "+Input1);
		Assert.assertEquals(Details1b, "Open Account Status = "+Input2);
