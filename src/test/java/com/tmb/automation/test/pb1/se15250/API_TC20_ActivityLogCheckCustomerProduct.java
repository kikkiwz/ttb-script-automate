...
public class API_TC20_ActivityLogCheckCustomerProduct extends Base {
	...
	@Test(groups = {"android", "PB1"}, description="ActivityLog Check Customer Product")
...
//ekYC Activity Log ----------------------------------------------------
		...
		String Input1 = "751850807";
		String Input2 = "Y or N";
		String Input3 = "Y or N";
		...
		hmC1.put("document_type", Input1);
		hmC1.put("valid_rm_id", Input2);
		hmC1.put("valid_product", Input3);
...
//Verify in ccweb ------------------------------------------------------------------
		...
		Assert.assertEquals(Details1a, "Document type = "+Input1);
		Assert.assertEquals(Details1b, "Have Customer ID in Bank system  = "+Input2);
		Assert.assertEquals(Details1c, "Have product in Bank system = "+Input3);
