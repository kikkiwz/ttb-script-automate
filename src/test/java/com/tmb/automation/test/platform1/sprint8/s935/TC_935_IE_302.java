...
public class TC_935_IE_302 extends Base {
	
	@Parameters({"DeviceProfile" })
	@BeforeMethod(groups= {"android", "plaform1", "Sprint8", "935",})
	public void BeforeTest(String deviceProfile) {
		Helper.CONFIG_PROFILE = deviceProfile;
//		resetEmail("001100000000000000000001184383", true);
...
//		hs.waitVisibleXpath(hs.swBtnHS_ChangeEmail);
		...
		hs.assertText(hs.fXPresent(hs.swLbHS_VerifyEmail), map("Text3"));
		
		log("TC_OneApp935_MB_POC_MessageTopic_VIT_00002	Validate Message Topic in Verify Email Card");
		hs.assertText(hs.fXPresent(hs.swLbHS_VerifyEmail), map("Text4"));
