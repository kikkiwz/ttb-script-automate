...
public class AutoLoanAccountDetails_Android_Eng extends Base {
    ...
    public void initial() throws InterruptedException, IOException {
        token = AutoloanUtility.genToken("eyJzZXJ2aWNlVHlwZSI6IkFMMDEwMCIsInRpbWVTdGFtcCI6MTYyODU4NzQzNzE3NCwiYWNjb3VudE51bWJlciI6IjI2NjAwODI5NCIsIm5pY2tOYW1lIjoiSGlyZVB1cmNoYXNlLTgyOTQifQ==");
        String URL = AutoloanUtility.redirectURL(token);
        String filepath = System.getProperty("user.dir") + "/src/main/resources/" + "chromedriver_92" + ".exe";
    ...
    private void CheckHPAccountdetail() throws InterruptedException, IOException {
        token = AutoloanUtility.genToken("eyJzZXJ2aWNlVHlwZSI6IkFMMDEwMCIsInRpbWVTdGFtcCI6MTYxNDA1NjE4MDM5NSwiYWNjb3VudE51bWJlciI6MjY2MDA4Mjk0Iiwibmlja05hbWUiOiJIaXJlUHVyY2hhc2UtODI5NCJ9");
        accountDetail = AutoloanUtility.JsonAccountDetail(token);
        Thread.sleep(5000);
