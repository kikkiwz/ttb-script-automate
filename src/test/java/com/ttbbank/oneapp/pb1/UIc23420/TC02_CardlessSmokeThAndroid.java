...
public class TC02_CardlessSmokeThAndroid extends BaseScenario {
	...
	@Test(groups = {"android", "PB1"}, description="Cardless Smoke Android")
...
//		enterPin();
		...
		System.out.println("Amount helper1-- "+ ttbTestContext.findElement(OneAppElementKeys.PB1_CARDLESS_FIELD_HELP_TEXT).getText());
		Thread.sleep(1000);
		...
		ttbTestContext.findElement(OneAppElementKeys.PB1_CARDLESS_AMOUNT_FIELD).clear();
		ttbTestContext.findElement(OneAppElementKeys.PB1_CARDLESS_AMOUNT_FIELD).sendKeys("22000");
		System.out.println("EnterAmount1-- 22000.00");
		...
		System.out.println("EnterAmount1-- 18000.00");
