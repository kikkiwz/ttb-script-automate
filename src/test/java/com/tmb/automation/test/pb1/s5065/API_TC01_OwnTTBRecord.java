...
public class API_TC01_OwnTTBRecord extends Base {
	...
	@Test(groups = {"android", "PB1"}, dataProvider="getExcelData", description="OwnTTBRecord")
...
//Customer Details Check Available Balance ----------------------------------------------------
		...
		System.out.println("/////////body customer details///////////-  "+"\n" +hmC);
...
//Receiver Check Remaining Balance ---------------------------------------------------
		...
		System.out.println("/////////body receiver check bal///////////-  "+"\n" +hmC2);
...
//Transfer and Validation -------------------------------------------------------------------
		...
		System.out.println("/////////body transfer validate///////////-  "+"\n" +hm);
