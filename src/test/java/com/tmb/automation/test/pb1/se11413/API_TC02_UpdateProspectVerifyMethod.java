...
public class API_TC02_UpdateProspectVerifyMethod extends Base {
	...
	@Test(groups = { "android", "PB1" }, description = "Update Prospect VerifyMethod")
...
//Update verify Method 7-11----------------------------------------------------
		...
		System.out.println("///////////Prospect Verify Method 7-11 Success/////////////// ");
		
//ekYC Script Prospect Verify Method MB ----------------------------------------------------
		HashMap<String, Object> hmC1 =new HashMap<>();
		hmC1.put("prospect_id", dataP1);
		hmC1.put("verify_method", "MB");
		...
		System.out.println("///////////Prospect Verify Method MB /////////////// ");					
	}
}
