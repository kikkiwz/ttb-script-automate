...
public class API_TC04_AddressListTh extends Base {
	...
	@Test(groups = {"android", "PB1"}, description="Address Thai Pin1")
...
//ekYC Script Address List ----------------------------------------------------	
	...
	@Test(groups = {"android", "PB1"}, description="Address Thai Pin2")
