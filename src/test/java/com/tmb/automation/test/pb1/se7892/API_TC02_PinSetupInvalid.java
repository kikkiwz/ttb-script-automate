...
public class API_TC02_PinSetupInvalid extends Base {
	...
	@Test(groups = {"android", "PB1"}, description="PinSetup Invalid")
	public void Test003 () throws InterruptedException, IOException, ParseException {
...
//ekYC Script ---------------------------------------------------------------------------------
		...
		if (time_from.before(timeNow) && time_to.after(timeNow)) {
			...
			String CodeExpectedC3= "pin_0001";
			...
			String messageexpectedC3 = "invalid pin";
			...
			String messageexpectedD3 = "Unable to proceed. For more information please call 1428.";
		...
		System.out.println("///////////Pin Setup Passed/////////////// ");
	}

	@Test(groups = {"android", "PB1"}, description="PinSetup")
	public void Test004 () throws InterruptedException, IOException, ParseException {
		log("------------Start "+this.getClass().getSimpleName());
...
//ekYC Script ---------------------------------------------------------------------------------
		String Pin555789 = map("pin555789");
		String PinSetup = ApiUrlEKYC.PinSetup;
		System.out.println("///////Pin555789////////////-  " + "\n" + Pin555789);
		System.out.println("////////PinSetup///////////-  " + "\n" + PinSetup);

		HashMap<String, String> hmC1 =new HashMap<>();
		hmC1.put("pin", Pin555789);
		System.out.println("/////////body///////////-  "+"\n" +hmC1);
