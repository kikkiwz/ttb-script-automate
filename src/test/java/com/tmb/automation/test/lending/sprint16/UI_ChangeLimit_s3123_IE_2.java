...
public class UI_ChangeLimit_s3123_IE_2 extends Base {
...
//		ld.writeLog();
		...
		WebElement el3 = ld.fX("//XCUIElementTypeStaticText[@value=\'April\']");
		WebElement el4 = ld.fX("//XCUIElementTypeStaticText[@value=\'March\']");
