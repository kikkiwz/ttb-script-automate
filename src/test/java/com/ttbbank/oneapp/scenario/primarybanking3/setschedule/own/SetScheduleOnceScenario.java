...
public class SetScheduleOnceScenario extends PrimaryBanking3Base {
    String fromAccountNumber;
    String toAccountNumber;
    String scheduleName;
    String scheduleStartDate;

    @Test(groups = "Set schedule once", priority = 1)
    ...
    @Test(groups = "Set schedule once", priority = 2)
    ...
    @Test(groups = "Set schedule once", priority = 3)
    ...
    @Test(groups = "Set schedule once", priority = 4)
    ...
    @Test(groups = "Set schedule once", priority = 5)
