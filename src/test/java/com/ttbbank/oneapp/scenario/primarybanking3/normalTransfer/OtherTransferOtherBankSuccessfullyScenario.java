...
public class OtherTransferOtherBankSuccessfullyScenario extends PrimaryBanking3Base {

    String fromAccountNumber;
    String toAccountNumber;

    @Test(groups = "Transfer other bank success", priority = 1)
    ...
    @Test(groups = "Transfer other bank success", priority = 2)
    ...
    @Test(groups = "Transfer other bank success", priority = 3)
    ...
    @Test(groups = "Transfer other bank success", priority = 4)
    public void testDataAssertEqualsEnterDetailsOnReviewScreenAndTapOnConfirm() throws IOException {
        ...
        evaluateAssertEqual(
                context.findElement(OneAppElementKeys.PB3_OTHER_TRANSFER_OTHER_BANK_ACCOUNT).getText(),
                toAccountNumber,
                "Validate to account number is displayed correctly (the same as entered in enter detail before)"
        );

        evaluateAssertEqual(
                context.findElement(OneAppElementKeys.PB3_OTHER_TRANSFER_BANK_SCB).getText(),
                "SCB",
    ...
    @Test(groups = "Transfer other bank success", priority = 5)
