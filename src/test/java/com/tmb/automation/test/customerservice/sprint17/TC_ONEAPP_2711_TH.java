...
public class TC_ONEAPP_2711_TH extends Base {
    ...
    @Test(priority = 0)
    public void TS_ONEAPP_2711_TH_VPOneAcct_SIT_00001() throws Exception {
        //OpenService();
...
//        File scrFile = ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
        ...
        System.err.println("eltextInNote : " + eltextInNote);
        ...
        System.err.println("eltextInNote2 : " + eltextInNote2);
        ...
        System.err.println("btnBackMain : " + btnBackMain);
        ...
        System.err.println("elbtnPDFfile : " + elbtnPDFfile);
        System.err.println("Application Started....");

        Assert.assertTrue(elTextHeader.equals("หน้าสมุดบัญชี"));
        ...
        Assert.assertTrue(elbtnBackMain.equals("กลับหน้าหลัก"));
        Assert.assertTrue(elbtnImage.equals("ไฟล์ ภาพ"));
        Assert.assertTrue(elbtnPDFfile.equals("ไฟล์ PDF"));
    }

    @Test(priority = 1)
    public void TS_ONEAPP_2711_TH_VPOneAcct_SIT_00002() throws Exception {
        ...
        String elPassbooklistTitleLabel = PassbooklistTitleLabel.getText();
         Assert.assertTrue(elPassbooklistTitleLabel.equals("เลือกบัญชีที่คุณต้องการ"));
    }
}
