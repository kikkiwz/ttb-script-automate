...
public class TC10_CitizenTTBPinTest extends Base {
	...
	public Object[][] getExcelData() throws IOException {
		Object Data[][] = Helper.testadataDataprovider("TestData_pb1", "CitizenTTB");
		return Data;
	}

	@Test(groups = { "android", "PB1" }, dataProvider = "getExcelData", description = "CitizenID TTB Bank Transfer")
	public void Test001(String aa1, String bb1, String cc1) throws InterruptedException, IOException {
		...
		pb1.TypeAmount().sendKeys("119.00");
		Thread.sleep(2000);
		appiumDriver.hideKeyboard();
