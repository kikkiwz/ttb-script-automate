...
import com.ttbbank.oneapp.scenario.investment.SearchFundFromIntroToInvestTestScenario;
import com.ttbbank.oneapp.scenario.investment.SearchFundFromMyMutualFundTestScenario;
...
public class SearchFundFromIntroToInvestRunner extends SearchFundFromIntroToInvestTestScenario {
    ...
    public void BeforeTest(@Optional String deviceProfile) throws MalformedURLException {
        ...
        ExtentTest feature = extentReports.createTest("Search Fund");
        setFeature(feature);
