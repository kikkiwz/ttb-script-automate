...
public class SetScheduleOtherToOwnAccountWeeklyByEndDateScenario extends PrimaryBanking3Base {
    String fromAccountNumber;
    String toAccountNumber;
    String scheduleName;
    String scheduleStartDate;
    String scheduleDayEvery;
    String scheduleEndDate;

    @Test(groups = "Set schedule other transfer to own account by end date frequency weekly", priority = 1)
    ...
    @Test(groups = "Set schedule other transfer to own account by end date frequency weekly", priority = 2)
    ...
    @Test(groups = "Set schedule other transfer to own account by end date frequency weekly", priority = 3)
    public void testFilledSetscheduleEnterDetailAndNextToReviewScreenSuccess() throws IOException {
        ...
        context.findElement(OneAppElementKeys.PB3_OTHER_TRANSFER_AMOUNT_TEXT_FIELD_WITHOUT_DAILYLIMIT).click();
        context.findElement(OneAppElementKeys.PB3_ENTER_DETAILS_KEYBOARD_NUMBER_ONE).click();
        context.findElement(OneAppElementKeys.PB3_ENTER_DETAILS_KEYBOARD_NUMBER_ZERO).click();
        context.findElement(OneAppElementKeys.PB3_ENTER_DETAILS_KEYBOARD_NUMBER_ZERO).click();
        context.findElement(OneAppElementKeys.PB3_ENTER_DETAILS_KEYBOARD_NUMBER_ZERO).click();
        ...
        context.findElement(OneAppElementKeys.PB3_SET_SCHEDULE_BUTTON_WITH_OTHER_OWN_XPATH).click();
        context.findElement(OneAppElementKeys.PB3_SET_SCHEDULE_NAME_TEXTFIELD_WITH_OTHER_OWN_XPATH).click();
        randomStringAndPress();
        context.findElement(OneAppElementKeys.PB3_KEYPAD_DONE).click();
        scheduleName = context.findElement(OneAppElementKeys.PB3_SET_SCHEDULE_NAME_TEXTFIELD_WITH_OTHER_OWN_XPATH).getText();

        context.findElement(OneAppElementKeys.PB3_SET_SCHEDULE_START_DATE_TEXTFIELD_WITH_OTHER_OWN_XPATH).click();
        context.findElement(OneAppElementKeys.PB3_KEYPAD_DONE).click();
        scheduleStartDate = context.findElement(OneAppElementKeys.PB3_SET_SCHEDULE_START_DATE_TEXTFIELD_WITH_OTHER_OWN_XPATH).getText();

        context.findElement(OneAppElementKeys.PB3_SCHEDULE_FREQUENCY_WEEKLY_RADIO).click();
        context.findElement(OneAppElementKeys.PB3_SET_SCHEDULE_END_DATE_TEXTFIELD_WITH_OTHER_OWN_XPATH).click();
        context.findElement(OneAppElementKeys.PB3_KEYPAD_DONE).click();
        scheduleEndDate = context.findElement(OneAppElementKeys.PB3_SET_SCHEDULE_END_DATE_TEXTFIELD_WITH_OTHER_OWN_XPATH).getText();
        scheduleDayEvery = context.findElement(OneAppElementKeys.PB3_SET_SCHEDULE_EVERY_DATE_WITH_OTHER_OWN_XPATH).getText();
    ...
    @Test(groups = "Set schedule other transfer to own account by end date frequency weekly", priority = 4)
    public void testDataAssertEqualsEnterDetailsOnReviewScreenAndTapOnConfirm() throws IOException {
        ...
        evaluateAssertEqual(
                context.findElementByAccessibilityId(scheduleDayEvery).getText(),
                scheduleDayEvery,
                "Validate schedule day of execute is displayed correctly (the same as entered in enter detail before)"
        );

        evaluateAssertEqual(
                context.findElementByAccessibilityId("1").getText(),
                "1",
                "Validate schedule times of execute is displayed correctly (the same as entered in enter detail before)"
        );
    ...
    @Test(groups = "Set schedule other transfer to own account by end date frequency weekly", priority = 5)
    public void testDataAssertEqualsReviewScreenAndTapOnBackToTransferLandingSuccess() throws IOException {
        ...
        evaluateAssertEqual(
                context.findElementByAccessibilityId(toAccountNumber).getText(),
                toAccountNumber,
