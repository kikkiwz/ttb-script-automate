...
public class SetScheduleOtherTTBWeeklyByEndDateScenario extends PrimaryBanking3Base {
    ...
    @Test(groups = "SetScheduleTransferOtherToOtherTTBAccountWeeklyByEndDateScenario", priority = 1)
    ...
    @Test(groups = "SetScheduleTransferOtherToOtherTTBAccountWeeklyByEndDateScenario", priority = 2)
    ...
    @Test(groups = "SetScheduleTransferOtherToOtherTTBAccountWeeklyByEndDateScenario", priority = 3)
    ...
    @Test(groups = "SetScheduleTransferOtherToOtherTTBAccountWeeklyByEndDateScenario", priority = 4)
    ...
    @Test(groups = "SetScheduleTransferOtherToOtherTTBAccountWeeklyByEndDateScenario", priority = 5)
