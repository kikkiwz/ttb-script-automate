...
public class API_TC10_ActivityLogScanID extends Base {
...
//ekYC Activity Log ----------------------------------------------------
		...
		String Input1 = "Step (3/16) : eKYC - Scan ID card";
...
//Verify in ccweb ------------------------------------------------------------------
		...
		Assert.assertEquals(Details1a, "Step (3/16) = "+Input1);
		Assert.assertEquals(Details1b, "Scan Result = "+Input2);
