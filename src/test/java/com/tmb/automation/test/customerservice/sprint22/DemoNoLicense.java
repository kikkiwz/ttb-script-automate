...
public class DemoNoLicense extends Base {
    ...
    public void TS_ONEAPP_8266_EN_PWA_BUSI_HRS_SIT_00002() throws Exception {
        ...
        Assert.assertTrue(elNameAdvisor.equals(JsonDataEligibility.get("full_name_en")));
...
//            String elPlaceholder = Placeholder.getText();
            ...
            Assert.assertTrue(elMobilenumber.equals(JsonDataEligibility.get("advisor_mobile_number")));
...
//        ((AndroidDriver<MobileElement>) appiumDriverMobile).startActivity(gmail);
        ...
        System.err.println("get elSubject : " + elSubject);
