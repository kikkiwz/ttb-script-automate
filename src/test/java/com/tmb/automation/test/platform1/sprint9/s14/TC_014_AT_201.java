...
public class TC_014_AT_201 extends Base {
	...
	public void ADTest001() throws IOException {
		...
		hs.assertText(hs.fX(hs.saLbHS_EnterYourPin).getText(), map("Pin_Title_TH"));
		...
		hs.assertText(hs.fX(hs.saBtnHS_ForgetPIN).getText(), map("ForgetPin_TH"));
