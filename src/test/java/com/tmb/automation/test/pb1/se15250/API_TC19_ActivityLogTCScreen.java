...
public class API_TC19_ActivityLogTCScreen extends Base {
	...
	@Test(groups = {"android", "PB1"}, description="ActivityLog TC Screen")
...
//ekYC Activity Log ----------------------------------------------------
		...
		hmC1.put("click_on", Input1);
		hmC1.put("t_and_c_version", Input2);
...
//Verify in ccweb ------------------------------------------------------------------
		...
		Assert.assertEquals(Details1a, "Click on = "+Input1);
		Assert.assertEquals(Details1b, "T&C version = "+Input2);
