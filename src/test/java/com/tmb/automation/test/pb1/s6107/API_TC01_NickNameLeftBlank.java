...
public class API_TC01_NickNameLeftBlank extends Base {
	...
	public Object[][] getExcelData() throws IOException {
		Object Data[][] = Helper.testadataDataprovider("TestData_pb1", "NickNameLeftBlank"); 
		return Data; 	}

	@Test(groups = { "android", "PB1" }, dataProvider = "getExcelData", description = "NickNameLeftBlank")
...
//		else {
		...
		Assert.assertEquals(nickNameENL1, productNameENL1, "NickName validated");
		Assert.assertEquals(nickNameTHL1, productNameTHL1, "NickName validated");
//		}
