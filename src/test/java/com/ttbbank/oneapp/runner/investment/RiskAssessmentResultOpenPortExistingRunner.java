...
import com.ttbbank.oneapp.scenario.investment.RiskAssessmentResultFromSuitQuestionTestScenario;
import com.ttbbank.oneapp.scenario.investment.RiskAssessmentResultOpenPortExistingTestScenario;
...
public class RiskAssessmentResultOpenPortExistingRunner extends RiskAssessmentResultOpenPortExistingTestScenario {
    ...
    public void BeforeTest(@Optional String deviceProfile) throws MalformedURLException {
        ...
        ExtentTest feature = extentReports.createTest("Risk Assessment Result");
        setFeature(feature);
