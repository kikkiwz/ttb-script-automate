...
public class API_TC21_ActivityLogSendOTP extends Base {
	...
	@Test(groups = {"android", "PB1"}, description="ActivityLog SendOTP Pass")
	public void TC01_SendOTPPass() throws InterruptedException, IOException {
...
//ekYC Activity Log ----------------------------------------------------
		...
		String step_number = "Step (7/16) : eKYC - Send OTP";
...
//Verify in ccweb ------------------------------------------------------------------
	...
	@Test(groups = {"android", "PB1"}, description="ActivityLog SendOTP Fail")
	public void TC02_SendOTPFail() throws InterruptedException, IOException {
		log("------------Start "+this.getClass().getSimpleName());
