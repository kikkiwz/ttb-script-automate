...
import com.ttbbank.oneapp.scenario.investment.KnowTTBSmartPortScenario;
...
public class KnowTTBSmartPortRunner extends KnowTTBSmartPortScenario {
    ...
    public void BeforeTest(@Optional String deviceProfile) throws MalformedURLException {
        ...
        ExtentTest feature = extentReports.createTest("Learn more about ttb smart port");
        setFeature(feature);
