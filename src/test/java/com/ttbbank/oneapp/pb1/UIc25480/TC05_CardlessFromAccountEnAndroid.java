package com.ttbbank.oneapp.pb1.UIc25480;
...
public class TC05_CardlessFromAccountEnAndroid extends BaseScenario {
	...
	@Test(groups = {"android", "PB1"}, description="CardlessFromAccount Android")
	public void cardlessFromAccount() throws InterruptedException, IOException {
		...
		ttbTestContext.waitUntilVisible(OneAppElementKeys.PB1_ACCOUNT);
		ttbTestContext.findElement(OneAppElementKeys.PB1_ACCOUNT).click();
		
		ttbTestContext.findElement(OneAppElementKeys.PB1_HOME_INTRO_NEXT).click();
//		enterPin();
		
		ttbTestContext.findElement(OneAppElementKeys.PB1_DEPOSIT_ACCOUNT_LIST).click();

		ttbTestContext.waitUntilVisible(OneAppElementKeys.PB1_ACCOUNT_NICKNAME);
		System.out.println("Waiting for Menu 10 second");
		Thread.sleep(10000);
		System.out.println("Continue");

		ttbTestContext.findElement(OneAppElementKeys.PB1_MORE_MENU).click();

		ttbTestContext.waitUntilVisible(OneAppElementKeys.PB1_MENU_TITLE);
		ttbTestContext.findElement(OneAppElementKeys.PB1_CARDLESS_WITHDRAW).click();
		...
		String AccountType = ttbTestContext.findElement(OneAppElementKeys.PB1_CARDLESS_AC_TYPE).getText();		
		System.out.println("AccountType-- " + AccountType);
		String FromAccount = ttbTestContext.findElement(OneAppElementKeys.PB1_CARDLESS_FROM_AC).getText();		
		System.out.println("FromAccount-- " + FromAccount);
		String AccountBalance = ttbTestContext.findElement(OneAppElementKeys.PB1_CARDLESS_BALANCE).getText();		
		System.out.println("AccountBalance-- " + AccountBalance);

		String EnterAmountError = ttbTestContext.findElement(OneAppElementKeys.PB1_CARDLESS_FIELD_HELP_TEXT).getText();
		...
		String EnterAmountError1 = ttbTestContext.findElement(OneAppElementKeys.PB1_CARDLESS_FIELD_HELP_TEXT).getText();
		...
		String EnterAmountError2 = ttbTestContext.findElement(OneAppElementKeys.PB1_CARDLESS_FIELD_HELP_TEXT).getText();
		...
		ttbTestContext.findElement(OneAppElementKeys.PB1_CARDLESS_AMOUNT_FIELD).clear();
		ttbTestContext.findElement(OneAppElementKeys.PB1_CARDLESS_AMOUNT_FIELD).sendKeys("18000");
		System.out.println("EnterAmount3-- 18000.00");
		String EnterAmountError3 = ttbTestContext.findElement(OneAppElementKeys.PB1_CARDLESS_FIELD_HELP_TEXT).getText();
		...
		Assert.assertEquals(AccountType, WithdrawAccountType);
		...
		ttbTestContext.waitUntilVisible(OneAppElementKeys.PB1_MORE_MENU);
		ttbTestContext.findElement(OneAppElementKeys.PB1_MORE_MENU).click();
		ttbTestContext.waitUntilVisible(OneAppElementKeys.PB1_MENU_TITLE);
		ttbTestContext.findElement(OneAppElementKeys.PB1_CARDLESS_WITHDRAW).click();		  
		...
		String PinExpireTitle = ttbTestContext.findElement(OneAppElementKeys.PB1_CARDLESS_PIN_EXPIRE_TITLE).getText();
