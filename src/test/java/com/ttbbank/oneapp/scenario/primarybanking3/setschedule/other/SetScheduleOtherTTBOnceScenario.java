...
public class SetScheduleOtherTTBOnceScenario extends PrimaryBanking3Base {
    String fromAccountNumber;
    String toAccountNumber;
    String scheduleName;
    String scheduleStartDate;

    @Test(groups = "SetScheduleTransferOtherToOtherTTBAccountOnceScenario", priority = 1)
    ...
    @Test(groups = "SetScheduleTransferOtherToOtherTTBAccountOnceScenario", priority = 2)
    ...
    @Test(groups = "SetScheduleTransferOtherToOtherTTBAccountOnceScenario", priority = 3)
    ...
    @Test(groups = "SetScheduleTransferOtherToOtherTTBAccountOnceScenario", priority = 4)
    ...
    @Test(groups = "SetScheduleTransferOtherToOtherTTBAccountOnceScenario", priority = 5)
