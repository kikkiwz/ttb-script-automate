...
public class TopUpScheduleTrueHWeeklyTimesScenario extends PrimaryBanking7Base{
    String fromAccountNumber;
    String scheduleStartDate;
    String scheduleAmountOfTimes;

    @Test(groups = "Topup schedule TrueH weekly times success", priority = 1)
    ...
    @Test(groups = "Topup schedule TrueH weekly times success", priority = 2)
    public void testTapTrueHMenu() throws InterruptedException, IOException {
        setScenario("2. Customer click TrueH menu go to the enter detail screen");
        TtbTestContext context = getTtbTestContext();
        Thread.sleep(1000);
        context.findElement(OneAppElementKeys.PB7_TOPUP_TRUEH).click();
    ...
    @Test(groups = "Topup schedule TrueH weekly times success", priority = 3)
    public void testFilledRef1AndSelectAmountEnterDetail() throws IOException {
        ...
        context.findElement(OneAppElementKeys.PB7_TOPUP_STEP_AMOUNT_90).click();

        createScreenShot("Show enter detail screen filled information", true);
    }

    @Test(groups = "Topup schedule TrueH weekly times success", priority = 4)
    public void testToggleSetScheduleAndEnterDetail() throws IOException {
        ...
        context.findElement(OneAppElementKeys.PB7_KEY_BOARD_THREE).click();
    ...
    @Test(groups = "Topup schedule TrueH weekly times success", priority = 5)
    ...
    @Test(groups = "Topup schedule TrueH weekly times success", priority = 6)
    public void testValidateScheduleReviewInfo() throws IOException {
        ...
        evaluateAssertEqual(
                context.findElement(OneAppElementKeys.PB7_TOPUP_SCHEDULE_REVIEW_SCHEDULE_NAME_TRUEH_WEEKLY).getText(),
                "Test 03",
        ...
        evaluateAssertEqual(
                context.findElement(OneAppElementKeys.PB7_TOPUP_REVIEW_REF1_TRUEH).getText(),
                "064-837-1960",
                "Validate reference one is displayed correctly (the same as entered in enter detail before)"
        );

        evaluateAssertEqual(
                context.findElement(OneAppElementKeys.PB7_TOPUP_SCHEDULE_REVIEW_AMOUNT_90).getText(),
                "90.00",
    ...
    @Test(groups = "Topup schedule TrueH weekly times success", priority = 7)
    ...
    @Test(groups = "Topup schedule TrueH weekly times success", priority = 8)
