...
import com.ttbbank.oneapp.scenario.investment.HomeScenario;
...
public class HomeRunner extends HomeScenario {
    ...
    public void BeforeTest(@Optional String deviceProfile) throws MalformedURLException {
        ...
        ExtentTest feature = extentReports.createTest("Widget search fund from home page");
        setFeature(feature);
