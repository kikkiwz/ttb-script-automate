...
public class SetScheduleWeeklyByTimesScenario extends PrimaryBanking3Base {
    String fromAccountNumber;
    String toAccountNumber;
    String scheduleName;
    String scheduleAmountOfTimes;

    @Test(groups = "Set schedule weekly by times", priority = 1)
    ...
    @Test(groups = "Set schedule weekly by times", priority = 2)
    ...
    @Test(groups = "Set schedule weekly by times", priority = 3)
    ...
    @Test(groups = "Set schedule weekly by times", priority = 4)
    ...
    @Test(groups = "Set schedule weekly by times", priority = 5)
