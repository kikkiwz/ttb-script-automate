...
import com.ttbbank.oneapp.scenario.investment.MyMutualFundTestScenario;
...
public class MyMutualFundRunner extends MyMutualFundTestScenario {
    ...
    public void BeforeTest(@Optional String deviceProfile) throws MalformedURLException {
        ...
        ExtentTest feature = extentReports.createTest("My Mutual Fund");
        setFeature(feature);
