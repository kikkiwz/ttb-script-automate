...
public class SetScheduleMonthlyByEndDateScenario extends PrimaryBanking3Base {
    ...
    @Test(groups = "Set schedule monthly by end date", priority = 1)
    ...
    @Test(groups = "Set schedule monthly by end date", priority = 2)
    ...
    @Test(groups = "Set schedule monthly by end date", priority = 3)
    public void testFilledSetscheduleEnterDetailAndNextToReviewScreenSuccess() throws IOException {
        ...
        context.findElement(OneAppElementKeys.PB3_SCHEDULE_END_DATE_TEXTFIELD_MONTHLY).click();
        context.findElement(OneAppElementKeys.PB3_KEYPAD_DONE).click();
        scheduleEndDate = context.findElement(OneAppElementKeys.PB3_SCHEDULE_END_DATE_TEXTFIELD_MONTHLY).getText();
    ...
    @Test(groups = "Set schedule monthly by end date", priority = 4)
    ...
    @Test(groups = "Set schedule monthly by end date", priority = 5)
