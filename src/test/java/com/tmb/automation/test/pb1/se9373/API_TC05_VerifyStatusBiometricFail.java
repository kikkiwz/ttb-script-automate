...
public class API_TC05_VerifyStatusBiometricFail extends Base {
	...
	@Test(groups = { "android", "PB1" }, description = "VerifyStatus Biometric Fail")
...
// Update Prospect ----------------------------------------------------
		...
		response = given().relaxedHTTPSValidation().log().all().header("Content-Type", "application/json")
				...
				.body(hmC2).when().post(UpdateProspect).then().assertThat().statusCode(200).extract().response();
...
// Bank Transaction ----------------------------------------------------
		...
		hmC1.put("provider_list", idr); //get id1 bank to check verify status
...
//		System.out.println("///////////Waiting for 15seconds/////////////// ");
//		Thread.sleep(15000);
//		
//// Verify Status Biometrid Fail --------------------------------------------------------
//		HashMap<String, Object> hmC3 = new HashMap<>();
//		hmC3.put("prospect_id", dataP1);
//		hmC3.put("citizen_id", citizen_id);
...
//		String CodeExpectedV11 = "ekyc_ndid_0002";
...
//		String messageexpectedV1 = "verify biometric is fail.";
...
//		String messageexpectedV1D = "Unable to proceed your transaction. Sorry for inconvenience caused. For more information please call 1428";
//		System.out.println("/////////AssertmessageV1D///////-  " + "\n" + messageV1D);
//		Assert.assertEquals(messageV1D, messageexpectedV1D);
//
//		String messageV1I = jsV1.getString("data.provider.id");
//		System.out.println("/////////AssertServiceV1I///////-  " + "\n" + messageV1S);
//		Assert.assertEquals(messageV1I, idr);
//
//		String messageV1B = jsV1.getString("data.provider.name_en");
//		System.out.println("/////////AssertServiceV1B///////-  " + "\n" + messageV1B);
//		Assert.assertEquals(messageV1B, nar);
//		
//		System.out.println("///////////Verify Status Biometrid Fail Passed/////////////// ");	
		}
