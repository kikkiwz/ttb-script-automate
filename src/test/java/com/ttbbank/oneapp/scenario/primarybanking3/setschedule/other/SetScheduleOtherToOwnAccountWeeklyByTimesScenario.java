...
public class SetScheduleOtherToOwnAccountWeeklyByTimesScenario extends PrimaryBanking3Base {
    String fromAccountNumber;
    String toAccountNumber;
    String scheduleName;
    String scheduleAmountOfTimes;

    @Test(groups = "Set schedule other transfer to own account by amount of times frequency weekly", priority = 1)
    ...
    @Test(groups = "Set schedule other transfer to own account by amount of times frequency weekly", priority = 2)
    ...
    @Test(groups = "Set schedule other transfer to own account by amount of times frequency weekly", priority = 3)
    public void testFilledSetscheduleEnterDetailAndNextToReviewScreenSuccess() throws IOException {
        ...
        context.findElement(OneAppElementKeys.PB3_SET_SCHEDULE_AMOUNT_OF_TIMES_TEXTFIELD_WITH_OTHER_OWN_XPATH).click();
        context.findElement(OneAppElementKeys.PB3_ENTER_DETAILS_KEYBOARD_NUMBER_ONE).click();
        context.findElement(OneAppElementKeys.PB3_KEYPAD_DONE).click();
        scheduleAmountOfTimes = context.findElement(OneAppElementKeys.PB3_SET_SCHEDULE_AMOUNT_OF_TIMES_TEXTFIELD_WITH_OTHER_OWN_XPATH).getText();
    ...
    @Test(groups = "Set schedule other transfer to own account by amount of times frequency weekly", priority = 4)
    ...
    @Test(groups = "Set schedule other transfer to own account by amount of times frequency weekly", priority = 5)
