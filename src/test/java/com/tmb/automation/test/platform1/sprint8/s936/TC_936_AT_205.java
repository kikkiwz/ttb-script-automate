...
public class TC_936_AT_205 extends Base {
...
//		sleep(0.5);
		...
		hs.setText2(ver.fX(ver.swTxtVerifyEmail_Email), map("EmailValid_TH"));
...
//		//verify screen
		...
		hs.assertText(hs.fX(ver.swBtnOTPResendCode).getText(), map("ResendButton_TH"));
