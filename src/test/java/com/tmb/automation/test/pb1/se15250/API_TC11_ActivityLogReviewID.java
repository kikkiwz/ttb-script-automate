...
public class API_TC11_ActivityLogReviewID extends Base {
...
//ekYC Activity Log ----------------------------------------------------
		...
		String Input1 = "Step (4/16) : eKYC - Review ID card Info";
		String Input2 = "1-2345-67890-12-3";
		String Input3 = "Mr Full Name";
		String Input4 = "01-01-1980";
		String Input5 = "pass/fail";
		...
		hmC1.put("citzen_id", Input2);
		hmC1.put("name", Input3);
		hmC1.put("dob", Input4);
		hmC1.put("dopa_status", Input5);
...
//Verify in ccweb ------------------------------------------------------------------
		...
		Assert.assertEquals(Details1a, "Step (4/16) = "+Input1);
		Assert.assertEquals(Details1b, "ID Number = "+Input2);
		Assert.assertEquals(Details1c, "Name = "+Input3);
		Assert.assertEquals(Details1d, "Date Of Birth = "+Input4);
		Assert.assertEquals(Details1e, "DOPA Status = "+Input5);
