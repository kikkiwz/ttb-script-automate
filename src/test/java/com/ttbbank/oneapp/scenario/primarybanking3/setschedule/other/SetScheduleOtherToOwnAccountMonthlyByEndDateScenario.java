...
public class SetScheduleOtherToOwnAccountMonthlyByEndDateScenario extends PrimaryBanking3Base  {
    ...
    @Test(groups = "Set schedule other transfer to own account by end date frequency monthly", priority = 1)
    ...
    @Test(groups = "Set schedule other transfer to own account by end date frequency monthly", priority = 2)
    ...
    @Test(groups = "Set schedule other transfer to own account by end date frequency monthly", priority = 3)
    public void testFilledSetscheduleEnterDetailAndNextToReviewScreenSuccess() throws IOException {
        ...
        context.findElement(OneAppElementKeys.PB3_SET_SCHEDULE_END_DATE_MONTHLY_WITH_OTHER_OWN_XPATH).click();
        context.findElement(OneAppElementKeys.PB3_KEYPAD_DONE).click();
        scheduleEndDate = context.findElement(OneAppElementKeys.PB3_SET_SCHEDULE_END_DATE_MONTHLY_WITH_OTHER_OWN_XPATH).getText();
    ...
    @Test(groups = "Set schedule other transfer to own account by end date frequency monthly", priority = 4)
    ...
    @Test(groups = "Set schedule other transfer to own account by end date frequency monthly", priority = 5)
