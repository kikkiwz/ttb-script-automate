...
public class API_TC13_ActivityLogSaveProspect extends Base {
...
//ekYC Activity Log ----------------------------------------------------
		...
		String Input1 = "Step (6/16) : eKYC - Save Prospect";
		String Input2 = dataP1;
		String Input3 = "iPhone or Android";
		String Input4 = "pass / fail";
		...
		hmC1.put("prospect_id", Input2);
		hmC1.put("device_name", Input3);
		hmC1.put("liveness_result", Input4);
...
//Verify in ccweb ------------------------------------------------------------------
		...
		Assert.assertEquals(Details1a, "Step (6/16) = "+Input1);
		Assert.assertEquals(Details1b, "Prospect ID = "+Input2);
		Assert.assertEquals(Details1c, "Device Name = "+Input3);
		Assert.assertEquals(Details1d, "Liveness Detection result = "+Input4);
