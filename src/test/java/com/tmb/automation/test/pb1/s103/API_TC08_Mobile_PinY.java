...
public class API_TC08_Mobile_PinY extends Base {
	...
	@Test(groups = {"android", "PB1"}, dataProvider="getExcelData", description="Mobile PinFree")
...
//Customer Details Check Remaining Balance -------------------------------------------------		
		...
		System.out.println("////////////////responseStringR1//////////////////-  "+"\n" +responseStringR);
...
//		System.out.println("////NewBalR1///- "+"\n"+previousBalR1+"-"+transferAmoR1+"-"+feeAmoR1+"= "+newBalS1);
		...
		Assert.assertEquals(newBalS1, remaBalS1, "RemainingBalance Validated");
			...
			String responseStringR =response.asString();
			System.out.println("////////////////responseStringR2//////////////////-  "+"\n" +responseStringR);
