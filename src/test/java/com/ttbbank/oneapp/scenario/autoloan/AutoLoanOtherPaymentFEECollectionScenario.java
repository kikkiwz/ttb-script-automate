...
public class AutoLoanOtherPaymentFEECollectionScenario extends AutoLoanHomeScenario {
    @Test(groups = "Other Payment For Collection FEE", dependsOnGroups = "Enter Loan Home")
    public void receiptTaxInvoice() throws InterruptedException, IOException {
        ExtentTest scenario = getFeature().createNode(Scenario.class, "OtherPayment FEE Collection ");
        ...
        context.findElement(OneAppElementKeys.AUTO_LOAN_QR_FEE_PAYMENT_BTN).click();
