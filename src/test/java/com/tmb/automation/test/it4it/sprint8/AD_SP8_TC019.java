...
//
///**
// * Verify The Verify Email
// * @author Admin
// *
// */
//public class AD_SP8_TC019 extends Base {
...
//		
////		//Verify Verify Email
//		appLib.assertText(appLib.fXpath(homePage.swLbVerifyEmailTitle).getText(), "Verify Email");
//		appLib.assertText(appLib.fXpath(homePage.swLbVerifyEmailDescription).getText(), "For using app secure and efficiency please verify your email");
////		
...
//		appLib.assertText(appLib.fXpath(homePage.swLbTitle).getText(), "Verify Email");
//		appLib.assertText(appLib.fXpath(homePage.swLbDescription).getText(), "For using app secure and efficiency please verify your email");
