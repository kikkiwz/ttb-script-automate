...
public class API_TC03_PinSetupFail extends Base {
	...
	@Test(groups = {"android", "PB1"}, description="PinSetup Fail")
	public void Test005 () throws InterruptedException, IOException, ParseException {
...
//ekYC Script ---------------------------------------------------------------------------------
		...
		if (time_from.before(timeNow) && time_to.after(timeNow)) {
			...
			String messageexpectedC3 = "failure";
			...
			String messageexpectedD3 = "Invalid Request";
