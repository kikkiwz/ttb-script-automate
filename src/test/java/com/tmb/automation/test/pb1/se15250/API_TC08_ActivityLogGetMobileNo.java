...
public class API_TC08_ActivityLogGetMobileNo extends Base {
...
//ekYC Activity Log ----------------------------------------------------
		...
		String Input1 = "Step (1/16) : eKYC - Get Mobile Number";
		String Input2 = "AIS";
		String Input3 = "0987654789";
		...
		hmC1.put("provider_name", Input2);
		hmC1.put("mobile_no", Input3);
		hmC1.put("result", Input4);
...
//Verify in ccweb ------------------------------------------------------------------
		...
		Assert.assertEquals(Details1a, "Step (1/16) = "+Input1);
		Assert.assertEquals(Details1b, "Provider Name = "+Input2);
		Assert.assertEquals(Details1c, "Mobile No = "+Input3);
		Assert.assertEquals(Details1d, "Result = "+Input4);
