...
public class NcbByEmailScenario extends BaseScenario {
    ...
    public void TC_ONEAPP_10580_PBMFList_00001() throws Exception {
        ...
        String ServiceScreenFirst = "images/NcbByEmail_ServiceScreenFirst_" + ttbTestContext.getPlateFormName() + ".png";
        ...
        String AccountSummary = "images/NcbByEmail_AccountSummary_" + ttbTestContext.getPlateFormName() + ".png";
        ...
        String AccountDetail_validateBalance = "images/NcbByEmail_AccountDetail_validateBalance_" + ttbTestContext.getPlateFormName() + ".png";
        ...
        String AccountDetail_BackToService = "images/NcbByEmail_AccountDetail_BackToService_" + ttbTestContext.getPlateFormName() + ".png";
        ...
        try {
            ...
            String TutorialScreen = "images/NcbByEmail_TutorialScreen_" + ttbTestContext.getPlateFormName() + ".png";
            ...
            String WithoutGoTutorial = "images/NcbByEmail_WithoutGoTutorial_" + ttbTestContext.getPlateFormName() + ".png";
            takeScreenshot(WithoutGoTutorial);
            scenario.createNode(Given.class, "If the customer has already logged in for the first time, the system navigate to select delivery method screen without going through tutorial screen.").addScreenCaptureFromPath(WithoutGoTutorial).pass("Pass");
        }
    ...
    public void TS_ONEAPP_4514_EN_ASTTutorial_SIT_00002() throws Exception {
        ...
        String isNotSelectDelivery = "images/NcbByEmail_isNotSelectDelivery_" + ttbTestContext.getPlateFormName() + ".png";
        ...
        String SelectDelivery = "images/NcbByEmail_SelectDelivery_" + ttbTestContext.getPlateFormName() + ".png";
        takeScreenshot(SelectDelivery);
        CheckResultsReport(scenario.createNode(Given.class, "(In case select by email) If the customer has already selected delivery method The button next will be enable.").addScreenCaptureFromPath(SelectDelivery), result);
    ...
    public void TS_ONEAPP_4514_EN_ASTTutorial_SIT_00003() throws Exception {
        ...
        while (true){
            if(!ttbTestContext.findElement(OneAppElementKeys.NAME_LASTNAME_VALUE_PROCESS_2_NCB).getText().equals("undefined")){
        ...
        WebElement Email = ttbTestContext.findElement(OneAppElementKeys.LABEL_EMAIL_PROCESS_2_NCB);
        String elEmail = Email.getText();
        WebElement EmailValue = ttbTestContext.findElement(OneAppElementKeys.EMAIL_VALUE_PROCESS_2_NCB);
        String elEmailValue = EmailValue.getText();
        WebElement btnEditEmail = ttbTestContext.findElement(OneAppElementKeys.EDIT_BTN_EMAIL_PROCESS_2_NCB);
        ...
        String checkTheAccuracyOfInformation = "images/NcbByEmail_checkTheAccuracyOfInformation_" + ttbTestContext.getPlateFormName() + ".png";
        ...
        WebElement Note = ttbTestContext.findElement(OneAppElementKeys.REMARK_SEND_EMAIL_PROCESS_2_NCB);
        ...
        result = CheckResults(elDeliveryMethod, "E-mail", result);
        result = CheckResults(elEmail, "E-mail", result);
        result = CheckResults(elBtnEditMobile, "Edit", result);
        result = CheckResults(elBtnEditEmail, "Edit", result);
        ...
        result = CheckResults(elNote, "If the e-credit report is not successfully sent to your e-mail, Credit Bereau will send the credit report documents to your delivery address within 7 business days.", result);
        result = CheckResults(elBtnNext, "Next", result);

        String checkTheAccuracyOfInformation2 = "images/NcbByEmail_checkTheAccuracyOfInformation2_" + ttbTestContext.getPlateFormName() + ".png";
        ...
        Assert.assertTrue(elDeliveryMethod.equals("E-mail"));
        Assert.assertTrue(elEmail.equals("E-mail"));
        Assert.assertTrue(elBtnEditMobile.equals("Edit"));
        Assert.assertTrue(elBtnEditEmail.equals("Edit"));
        ...
        Assert.assertTrue(elNote.equals("If the e-credit report is not successfully sent to your e-mail, Credit Bereau will send the credit report documents to your delivery address within 7 business days."));
    ...
    public void TS_ONEAPP_4514_EN_ASTTutorial_SIT_00004() throws Exception {
        ...
        TmbServiceResponse<termNConditionResponse> responseTermNCondition = client.get("/apis/customer/termNCondition/NCB_EMAIL", eqParamsTermNCondition, termNConditionResponse.class);
        ...
        WebElement T_C_detail = ttbTestContext.findElement(OneAppElementKeys.TERM_AND_CONDITIONS_EMAIL_NCB);
        String elT_C_detail = T_C_detail.getText().replaceAll("\n","");

        String TermAndCondition_beforeAccept = "images/NcbByEmail_TermAndCondition_beforeAccept_" + ttbTestContext.getPlateFormName() + ".png";
        ...
        String TermAndCondition_beforeAccept2 = "images/NcbByEmail_TermAndCondition_beforeAccept2_" + ttbTestContext.getPlateFormName() + ".png";
        takeScreenshot(TermAndCondition_beforeAccept2);
        CheckResultsReport(scenario.createNode(Given.class, "If the customer isn't a checkbox, accept the terms and conditions. Next button is disable.").addScreenCaptureFromPath(TermAndCondition_beforeAccept2), result);

        AcceptT_C.click();

        String TermAndCondition_AfterAccept = "images/NcbByEmail_TermAndCondition_AfterAccept_" + ttbTestContext.getPlateFormName() + ".png";
...
//        System.err.println("elBalance2 : " + elBalance2);
        ...
        String BeforeSelectAccount = "images/NcbByEmail_BeforeSelectAccount_" + ttbTestContext.getPlateFormName() + ".png";
        ...
        String AfterSelectAccount = "images/NcbByEmail_AfterSelectAccount_" + ttbTestContext.getPlateFormName() + ".png";
    ...
    public void TS_ONEAPP_4514_EN_ASTTutorial_SIT_00006() throws Exception {
        ...
        String reviewInformation = "images/NcbByEmail_reviewInformation_" + ttbTestContext.getPlateFormName() + ".png";
        ...
        System.out.println("Mobile No. : " + formatAccount(responseCustInfoValidation.getData().mobile_no, "###-###-####"));
        result = CheckResults(elMobileNo, formatAccount(responseCustInfoValidation.getData().mobile_no, "###-###-####"), result);
        result = CheckResults(elLabelAddress, "Delivery address", result);
        result = CheckResults(elAddress, responseCustInfoValidation.getData().delivery_address, result);
        result = CheckResults(elNote, "Credit report will be sent by e-mail within 3 business days.", result);
        result = CheckResults(elBtnNext, "Confirm", result);

        String reviewInformation2 = "images/NcbByEmail_reviewInformation2_" + ttbTestContext.getPlateFormName() + ".png";
        ...
        WebElement pin = ttbTestContext.findElement(OneAppElementKeys.CONFIRM_PIN_0_BUTTON);
        String elPin = pin.getText();
        result = "";
        result = CheckResults(elPin, "0", result);

        String ConfirmPin = "images/NcbByEmail_ConfirmPin_" + ttbTestContext.getPlateFormName() + ".png";
        ...
        Assert.assertTrue(elDeliveryDetail.equals("By e-mail"));
        ...
        Assert.assertTrue(elLabelAddress.equals("Delivery address"));
        Assert.assertTrue(elAddress.equals(responseCustInfoValidation.getData().delivery_address));
        Assert.assertTrue(elNote.equals("Credit report will be sent by e-mail within 3 business days."));
    ...
    public void TS_ONEAPP_4514_EN_ASTTutorial_SIT_00007() throws Exception {
        ...
        String elDeliveryDetail = DeliveryDetail.getText();
        WebElement labelEmail = ttbTestContext.findElement(OneAppElementKeys.LABEL_EMAIL_SUCCESS_NCB);
        String elLabelEmail = labelEmail.getText();
        WebElement emailValue = ttbTestContext.findElement(OneAppElementKeys.EMAIL_VALUE_SUCCESS_NCB);
        String elEmailValue = emailValue.getText();
        ...
        String SuccessScreen1 = "images/NcbByEmail_SuccessScreen1_" + ttbTestContext.getPlateFormName() + ".png";
        ...
        RefNumber = elRefNo;
        WebElement remarkSuccess = ttbTestContext.findElement(OneAppElementKeys.REMARK_SUCCESS_NCB);
        String elRemarkSuccess = remarkSuccess.getText();
        ...
        System.err.println("elRemarkSuccess : " + elRemarkSuccess);
        ...
        result = CheckResults(elSuccessDetail, "Credit report will be sent by e-mail within 3 business form e-report@ncb.co.th. If you don't find e-mail in you inbox, please check your junk mail.", result);
        ...
        result = CheckResults(elRemarkSuccess, "If the e-credit report is not successfully sent to your e-mail, NCB will send the credit report document to your address within 7 business days.", result);
        ...
        result = CheckResults(elName_Surname, responseCustInfoValidation.getData().first_name_en + " " + responseCustInfoValidation.getData().last_name_en, result);
        result = CheckResults(elIDNumber, formatAccount(responseCustInfoValidation.getData().national_id, "#-####-#####-##-#"), result);
        System.err.println("result : " + formatAccount(responseCustInfoValidation.getData().mobile_no, "###-###-####"));
        result = CheckResults(elMobileNumber, formatAccount(responseCustInfoValidation.getData().mobile_no, "###-###-####"), result);
        ...
        result = CheckResults(elBtnBackToServicePage, "Back to Service Page", result);

        String SuccessScreen2 = "images/NcbByEmail_SuccessScreen2_" + ttbTestContext.getPlateFormName() + ".png";
        ...
        Assert.assertTrue(elSuccessDetail.equals("Credit report will be sent by e-mail within 3 business form e-report@ncb.co.th. If you don't find e-mail in you inbox, please check your junk mail."));
        ...
        Assert.assertTrue(elRemarkSuccess.equals("If the e-credit report is not successfully sent to your e-mail, NCB will send the credit report document to your address within 7 business days."));
    ...
    public void TS_ONEAPP_4514_EN_ASTTutorial_SIT_00009() throws Exception {
        ...
        String ServicePage = "images/NcbByEmail_ServicePage_" + ttbTestContext.getPlateFormName() + ".png";
        ...
        String LimitPerDay = "images/NcbByEmail_LimitPerDay_" + ttbTestContext.getPlateFormName() + ".png";
        ...
        String AfterClickOk = "images/NcbByEmail_AfterClickOk_" + ttbTestContext.getPlateFormName() + ".png";
    ...
    public void TS_ONEAPP_4514_EN_ASTTutorial_SIT_00010() throws Exception {
        ...
        String TabStatusTracking = "images/NcbByEmail_TabStatusTracking_" + ttbTestContext.getPlateFormName() + ".png";
        takeScreenshot(TabStatusTracking);
        scenario.createNode(Given.class, "Service screen on tab status tracking").addScreenCaptureFromPath(TabStatusTracking).pass("Pass");
...
//        result = CheckResults(elCaseIdDetail, "", result);
        ...
        String CheckCreateCaseTracking = "images/NcbByEmail_CheckCreateCaseTracking_" + ttbTestContext.getPlateFormName() + ".png";
    ...
    public void TS_ONEAPP_4514_EN_ASTTutorial_SIT_00011() throws Exception {
        ...
        while (true) {
            ...
            if (ttbTestContext.findElement(OneAppElementKeys.DATE_FINISH_TRACKING_DETAIL_SCREEN).getText().equals(datePayment.substring(0, 9))) {
                ...
                String CaseTrackingDetailNCB = "images/NcbByEmail_CaseTrackingDetailNCB_" + ttbTestContext.getPlateFormName() + ".png";
                ...
                String ServiceScreenAfterCheckCaseTracking = "images/NcbByEmail_ServiceScreenAfterCheckCaseTracking_" + ttbTestContext.getPlateFormName() + ".png";
...
//                Assert.assertTrue(elCaseID.equals(""));
    ...
    public void TS_ONEAPP_4514_EN_ASTTutorial_SIT_00008() throws Exception {
        ...
        String AccountSummaryAfterNCBPayment = "images/NcbByEmail_AccountSummaryAfterNCBPayment_" + ttbTestContext.getPlateFormName() + ".png";
    ...
    public void TS_ONEAPP_4514_EN_ASTTutorial_SIT_00012() throws Exception {
        ...
        while (true) {
            ...
            if (!balanceBeforePayment.equals(ttbTestContext.findElement(OneAppElementKeys.BALANCE_ACCOUNT_DETAIL_SCREEN).getText())) {
                ...
                String CheckBalanceAfterPayment = "images/NcbByEmail_CheckBalanceAfterPayment_" + ttbTestContext.getPlateFormName() + ".png";
                takeScreenshot(CheckBalanceAfterPayment);
                CheckResultsReport(scenario.createNode(Given.class, "Verify balance").addScreenCaptureFromPath(CheckBalanceAfterPayment), result);
