...
import com.ttbbank.oneapp.scenario.protection.CoverageSummaryScenario;
...
public class CoverageSummaryRunner extends CoverageSummaryScenario {
    ...
    public void BeforeTest(@Optional String deviceProfile) throws MalformedURLException {
        ...
        TtbTestContext ttbTestContext = getTtbTestContext();
		 ...
		 ExtentHtmlReporter("reports/Protection Coverage Summary.html");
		 extentReports.attachReporter(extentReporter); ExtentTest feature =
		 extentReports.createTest("Display Coverage Summary"); setFeature(feature);
