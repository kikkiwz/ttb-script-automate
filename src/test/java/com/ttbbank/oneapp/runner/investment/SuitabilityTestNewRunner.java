...
import com.ttbbank.oneapp.scenario.investment.SuitabilityTestFromOpenPortTestScenario;
import com.ttbbank.oneapp.scenario.investment.SuitabilityTestNewTestScenario;
...
public class SuitabilityTestNewRunner extends SuitabilityTestNewTestScenario {
    ...
    public void BeforeTest(@Optional String deviceProfile) throws MalformedURLException {
        ...
        ExtentTest feature = extentReports.createTest("Suitability test Question and Answer");
        setFeature(feature);
