...
public class AndroidCalculateClosingAccountRunner extends CalculateClosingAccountScenario {
    ...
    public void BeforeTest(String deviceProfile ) throws MalformedURLException {
        ...
        ExtentReporter extentReporter = new ExtentHtmlReporter("reports/android-calculate-close account.html");
