...
public class AutoLoanAndroidOneAppElements {

    private AutoLoanAndroidOneAppElements() {

    }

    //Auto Loan

    private static final OneAppElement AUTO_LOAN_MY_ACCOUNT = new OneAppElement(FindBy.ACCESSIBILITY_ID, "Loan");
    private static final OneAppElement AUTO_LOAN_1ST_ACCOUNT = new OneAppElement(FindBy.ID, "com.ttbbank.oneapp.vit:id/loanCard");
    private static final OneAppElement AUTO_LOAN_DETAIL = new OneAppElement(FindBy.CSS_SELECTOR, "#credit_landing_billed_list");
    private static final OneAppElement AUTO_LOAN_INSURANCE_DUE_DATE_LABEL = new OneAppElement(FindBy.ID, "al-insurance-due-date-label7");
    private static final OneAppElement AUTO_LOAN_PAYMENT_HISTORY_BTN = new OneAppElement(FindBy.XPATH, "//android.view.View[@text='Payment History']");
    private static final OneAppElement AUTO_LOAN_INSTALMENT_LABEL = new OneAppElement(FindBy.XPATH, "//android.widget.TextView[@text='Installment']");
    private static final OneAppElement AUTO_LOAN_PAYMENT_LIST_1ST = new OneAppElement(FindBy.XPATH, "//android.view.View[@resource-id='al-history-expand-button-0']");
    private static final OneAppElement AUTO_LOAN_PAYMENT_RECEIPT_DATE = new OneAppElement(FindBy.XPATH, "//android.view.View[@text='Receipt Date']");
    private static final OneAppElement AUTO_LOAN_PAYMENT_LIST_2ST = new OneAppElement(FindBy.XPATH, "(//android.view.View[@resource-id='al-history-expand-button-1']");
    private static final OneAppElement AUTO_LOAN_PAYMENT_LOAN_DETAIL_HEADER = new OneAppElement(FindBy.ID, "al-insurance-due-date-label7");
    private static final OneAppElement AUTO_LOAN_SERVICE_REQUEST_BUTTON = new OneAppElement(FindBy.XPATH, "//*[@id=\"shortcut-icon-more\"]");
    ...
    private static final OneAppElement AUTO_LOAN_CLOSE_ACCOUNT_NEXT_BUTTON = new OneAppElement(FindBy.CSS_SELECTOR, "#al-closing-account-information-next-button");
    ...
    private static final OneAppElement AUTO_LOAN_RECEIPT_FEE_VALUE = new OneAppElement(FindBy.XPATH, "(//*[@resource-id=\"com.ttbbank.oneapp.vit:id/edit_text\"])[3]");
    private static final OneAppElement AUTO_LOAN_PAY_BILL_HEADER = new OneAppElement(FindBy.ID, "com.ttbbank.oneapp.vit:id/txt_title");
    private static final OneAppElement AUTO_LOAN_PAY_BILL_NEXT_BTN = new OneAppElement(FindBy.ID, "com.ttbbank.oneapp.vit:id/button_next");
    private static final OneAppElement AUTO_LOAN_PAY_BILL_CONFIRM_BTN = new OneAppElement(FindBy.ID, "com.ttbbank.oneapp.vit:id/btn_confirm");
    private static final OneAppElement AUTO_LOAN_PAY_BILL_AMOUNT = new OneAppElement(FindBy.ID, "com.ttbbank.oneapp.vit:id/value_amount_exclude_fee");
    private static final OneAppElement AUTO_LOAN_PAY_BILL_HEADER_CONFIRM = new OneAppElement(FindBy.ID, "com.ttbbank.oneapp.vit:id/txt_title");
    ...
    public static void init(Map<String, OneAppElement> oneAppElementHashMap) {
        ...
        oneAppElementHashMap.put(OneAppElementKeys.AUTO_LOAN_PAYMENT_LIST_2, AUTO_LOAN_PAYMENT_LIST_2ST);
        oneAppElementHashMap.put(OneAppElementKeys.AUTO_LOAN_PAYMENT_RECEIPT_DATE, AUTO_LOAN_PAYMENT_RECEIPT_DATE);
        oneAppElementHashMap.put(OneAppElementKeys.AUTO_LOAN_PAYMENT_LOAN_DETAIL_HEADER, AUTO_LOAN_PAYMENT_LOAN_DETAIL_HEADER);
