...
public class MutualFund_EN extends Base {
    ...
    public void TC_ONEAPP_8852_NDID_EN_REQ_SIT_01001() throws Exception {
        ...
        MobileElement service = appiumDriverMobile.findElement(By.xpath("//*[@resource-id='2020']"));
        service.click();
        ...
        MobileElement MutualFundCode0 = appiumDriverMobile.findElementByXPath("//*[@resource-id='description_0']");
        ...
        Assert.assertTrue(elTitlePassBook.equals("Passbook"));
        Assert.assertTrue(elTitleMutualFund.equals("Mutual Fund Passbook"));
        Assert.assertTrue(elMutualFund0.equals("New Nickname"));
        ...
        Assert.assertTrue(elBtnView.equals("View"));
    ...
    public void TC_ONEAPP_10581_PBFundList_01001() throws Exception {
        ...
        Assert.assertTrue(elselectFund.equals("Select a Fund From -"));
        Assert.assertTrue(elPortfolioCode.equals("Portfolio Code : PT01829800"));
        Assert.assertTrue(elMutualFund0.equals("MODEL1"));
        Assert.assertTrue(elMutualFundName0.equals("Smart Port Model 1"));
        Assert.assertTrue(elMutualFund1.equals("MODEL2"));
        Assert.assertTrue(elMutualFundName1.equals("Smart Port Model 2"));
        Assert.assertTrue(elMutualFund2.equals("MODEL3"));
        Assert.assertTrue(elMutualFundName2.equals("Smart Port Model 3"));
        Assert.assertTrue(elMutualFund3.equals("TESCHINAA"));
        Assert.assertTrue(elMutualFundName3.equals("Thanachart Eastspring China A Active Fund"));
        Assert.assertTrue(elBtnView.equals("View"));
    ...
    public void TC_ONEAPP_10582_PBMF_00001() throws Exception {
        ...
        Assert.assertTrue(elremark.equals("remark:"));
        Assert.assertTrue(elRemarkDetail.equals("Mutualfund E-Passbook usage is to display unitholder name, fund name, Portfolio code, Office/Branch from ttb bank system"));
        Assert.assertTrue(elUnitholderNameValue.equals("เอ็มไอบีเอ็มไอบี เทสเอ็มเอฟ"));
        Assert.assertTrue(elFundNameValue.equals("Smart Port Model 1"));
    ...
    public void TC_ONEAPP_10584_PBMF_00001() throws Exception {
        ...
        System.err.println("elBtnImage : " + elBtnImage);
                ...
                Assert.assertTrue(elTitlePopupSave.equals("Select type of file to save"));
        Assert.assertTrue(elBtnPDF.equals("PDF"));
    ...
    public void TC_ONEAPP_10585_PBMF_00001() throws Exception {
        ...
        Assert.assertTrue(elTitlePopupShare.equals("Select type of file to share"));
        Assert.assertTrue(elBtnPDF.equals("PDF"));
        Assert.assertTrue(elBtnImage.equals("Image"));
