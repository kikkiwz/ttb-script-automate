...
public class DocumentMenuActivatedNCBScenario extends BaseScenario {
    @Test(groups = "Customer Service Document Menu Activated NCB", dependsOnGroups = {"Enter Home Screen Dev Latest","Enter Service Screen Dev Latest"})
