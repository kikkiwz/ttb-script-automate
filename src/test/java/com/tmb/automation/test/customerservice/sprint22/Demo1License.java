...
public class Demo1License extends Base {
    ...
    public void TS_ONEAPP_8266_EN_PWA_BUSI_HRS_SIT_00002() throws Exception {
        ...
        System.err.println("get elNote2 : " + elNote2);
              ...
              ShowMore.click();
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@resource-id='personal_wealth_advisor_bullet_desc_id0']")));
        ...
        Assert.assertTrue(JsonDataEligibility.get("full_name_en").equals(elNameAdvisor));
...
//                Assert.assertTrue(elNameAdvisor.equals(License.get("license_value_th"));
                Assert.assertTrue(elLicense1No.equals("License no. " + License.get("license_number")));
            }
        }
    }
