...
import com.ttbbank.oneapp.scenario.customerservice.sprint33.VirtualPassbookScenario;
...
public class VirtualPassbookRunner extends VirtualPassbookScenario {
    ...
    public void BeforeTest(@Optional String deviceProfile) throws MalformedURLException {
        ...
        ExtentReporter extentReporter = new ExtentHtmlReporter("reports/VirtualPassbook_"+ttbTestContext.getPlateFormName()+".html");
