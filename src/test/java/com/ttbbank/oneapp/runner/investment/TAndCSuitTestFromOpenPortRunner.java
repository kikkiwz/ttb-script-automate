...
import com.ttbbank.oneapp.scenario.investment.TAndCSuitFromInfoOpenPortScenario;
...
public class TAndCSuitTestFromOpenPortRunner extends TAndCSuitFromInfoOpenPortScenario {
    ...
    public void BeforeTest(@Optional String deviceProfile) throws MalformedURLException {
        ...
        ExtentTest feature = extentReports.createTest("Terms and Conditions for Suitability test");
        setFeature(feature);
