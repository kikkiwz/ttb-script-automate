package com.tmb.automation.test.lending.sprint24;
...
public class API_CashTransfer_1 {
    private String accessToken = "";
    private final JsonPath data = new JsonPath(Helper.getInput(System.getProperty("user.dir") + "/src/test/java/com/tmb/automation/test/lending/sprint24/CashForYou.json"));
