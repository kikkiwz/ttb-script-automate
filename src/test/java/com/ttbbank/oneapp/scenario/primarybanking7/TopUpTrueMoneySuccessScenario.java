...
public class TopUpTrueMoneySuccessScenario extends PrimaryBanking7Base{
    String fromAccountNumber;

    @Test(groups = "TopUp TrueMoney Success", priority = 1)
    ...
    @Test(groups = "TopUp TrueMoney Success", priority = 2)
    ...
    @Test(groups = "TopUp TrueMoney Success", priority = 3)
    ...
    @Test(groups = "TopUp TrueMoney Success", priority = 4)
    public void testDataAssertEqualsEnterDetailsOnReviewScreenAndTapOnConfirm() throws IOException {
        ...
        evaluateAssertEqual(
                context.findElement(OneAppElementKeys.PB7_TOPUP_REVIEW_AMOUNT_300).getText(),
                "400.00",
    ...
    @Test(groups = "TopUp TrueMoney Success", priority = 5)
    public void testDataAssertEqualsReviewScreenAndTapOnBackToHomeSuccess() throws IOException {
        ...
        evaluateAssertEqual(
                context.findElement(OneAppElementKeys.PB7_TOPUP_COMPLETE_REF1_TRUE_MONEY).getText(),
                "083-044-3596",
                "Validate reference one is displayed correctly (the same as entered in enter detail before)"
        );

        evaluateAssertEqual(
                context.findElement(OneAppElementKeys.PB7_TOPUP_COMPLETE_AMOUNT_300).getText(),
                "400.00",
                "Validate amount is displayed correctly (the same as entered in enter detail before)"
        );
