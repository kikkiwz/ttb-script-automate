...
public class ActivateAppTHScenario extends BaseScenario {

    @Test(groups = "Activate application with change language", dependsOnGroups = {"Activate new flow with change language"}, priority = 1)
    public void accessToInsuranceThaiLng() throws InterruptedException, IOException {
