package com.tmb.automation.test.pb1.s4190;
...
public class API_TC01_FeeForTD extends Base {
	...
	public  Object[][] getExcelData() throws IOException 	{
		 Object Data[][]=Helper.testadataDataprovider("TestData_pb1", "TD"); 
		 return Data; 	}
	
	@Test( dataProvider="getExcelData", description="Get Free for TD")
	public void Test001 (String aa1,String bb1,String cc1, String dd1) throws InterruptedException, IOException, SQLException{
...
//		String depthNo = map("depthNo");
		
		String toAccountNo = map("fromAccountNo"); //transfer to account
		String fromAccountNo = aa1; //Get data from DataProvider
...
//Transfer and Validation -------------------------------------------------------------------
		...
		String feeV1=js1.getString("data.tdfee");
		System.out.println("////////////////FeeV1//////////////////-  "+"\n"  + feeV1);
		Assert.assertEquals("0.0", feeV1, "sentAmount validated");
...
// Transfer Confirmation -----------------------------------------------------------------------
		...
		String accountId2a = accountId2.substring(0, accountId2.length() - 3); //remove last 3 charactor
		System.out.println("/////////////From Account2a//////////- "+"\n" + accountId2a);
		Assert.assertEquals(accountId2a, fromAccountNo, "accountId validated");
		...
		String toAcType2=js2.getString("data.toAccount.accountType");
		System.out.println("/////////////toAcType2//////////- "+"\n" + toAcType2);
		Assert.assertEquals(toAcType2, toAccountType, "toAccountNo validated");
		
		String transAmo2=js2.getString("data.transactionAmount");
		Double transAmo2a = Double.parseDouble(transAmo2);
		System.out.println("/////////////transAmo2a//////////- "+"\n" + transAmo2a);
		String transAmo2b = String.format("%.2f", transAmo2a);
//		DecimalFormat df = new DecimalFormat("#.##");
//		String transAmo2b = df.format(transAmo2a); 
		System.out.println("/////////////transAmo2b//////////- "+"\n" + transAmo2b);
		Assert.assertEquals(transAmo2b, amount, "transamount validated");

		String fee2=js2.getString("data.feeAmount");
		System.out.println("////////////////FeeV1//////////////////-  "+"\n"  + fee2);
		Assert.assertEquals(fee2, feeV1, "Fee validated");
				
		System.out.println("///////////Transfer Confirmation Success/////////////// ");	
		
//TD account Check Remaining Balance ---------------------------------------------------
