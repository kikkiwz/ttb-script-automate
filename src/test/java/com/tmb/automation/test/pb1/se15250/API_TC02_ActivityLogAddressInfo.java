...
public class API_TC02_ActivityLogAddressInfo extends Base {
...
//ekYC Activity Log ----------------------------------------------------
		...
		String Input1 = "Step (13/16) : eKYC - Address Info";
		String Input2 = "21st Floor, Nana Condo, BTS Nana, Bangkok 10100";
		String Input3 = "Condo 123, 789 Ashok Condo, BTS Ashok, Bangkok 10100";
		String Input4 = "3000 Phahonyothin Rd. Chom Phon, Khet Chatuchak, Bangkok 10900";
		...
		hmC1.put("registered_address", Input2);
		hmC1.put("contact_address", Input3);
		hmC1.put("office_address", Input4);
...
//Verify in ccweb ------------------------------------------------------------------
		...
		Assert.assertEquals(Details1a, "Step (13/16) = "+Input1);
		Assert.assertEquals(Details1b, "Registered Address = "+Input2);
		Assert.assertEquals(Details1c, "Contact Address = "+Input3);
		Assert.assertEquals(Details1d, "Office Address = "+Input4);
