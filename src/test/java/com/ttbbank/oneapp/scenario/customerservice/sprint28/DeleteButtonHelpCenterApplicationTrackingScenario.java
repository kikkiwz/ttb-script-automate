...
public class DeleteButtonHelpCenterApplicationTrackingScenario extends BaseScenario {
    @Test(groups = "Customer Service Delete Button Help Center Application Tracking", dependsOnGroups = {"Enter Home Screen Dev Latest","Enter Service Screen Dev Latest"})
...
//        ttbTestContext.horizontalSwipeByPercentage(0.9, 0.1, 0.3);
        ...
        WebElement STATUS_TRACKING_SERVICE_BUTTON = ttbTestContext.findElement(OneAppElementKeys.APPLICATION_TRACKING_SERVICE_BUTTON);
