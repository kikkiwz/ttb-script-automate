...
public class API_TC02_CancelRequestWrongProspect extends Base {
	...
	@Test(groups = { "android", "PB1" }, description = "Cancel Request Wrong Prospect")
...
// Verify Cancel Request Wrong Prospect --------------------------------------------------------
		...
		String CodeExpectedV11 = "ekyc_prospect_0001";
		...
		String messageexpectedV1 = "unable to update customer prospect data";
...
//		Assert.assertEquals(messageV1D, messageexpectedV1D);
		...
		System.out.println("///////////Verify Cancel Request Wrong Prospect Passed/////////////// ");	
	}
