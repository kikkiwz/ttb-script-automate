...
public class ApplySoGoodUnsucessScenario extends BaseScenario {

    @Test(groups = "Unsuccessful Apply So Good", dependsOnGroups = {"Open home screen VIT latest AD572 iOS435"})

    public void applySoGoodNormally() throws InterruptedException, IOException {
        TtbTestContext ttbTestContext = getTtbTestContext();
        ExtentTest scenario = getFeature().createNode(Scenario.class, "Unsuccessful Apply so good");
...
//        enterPin();
        ...
        String creditCard = "images/ApplySoGoodUnsuccess/Product Landing Page.png";
        ...
        String applySoGood = "images/ApplySoGoodUnsuccess/Apply so good first page.png";
        ...
        Thread.sleep(3000);
        String transactionPlan = "images/ApplySoGoodUnsuccess/Select Transaction page.png";
        ...
        transaction1.click();
        String selectedTran = "images/ApplySoGoodUnsuccess/Selected Transaction.png";
        ...
        Thread.sleep(3000);
        String installPlan = "images/ApplySoGoodUnsuccess/Installment plan page.png";
        ...
        WebElement select10Month = ttbTestContext.findElement(OneAppElementKeys.LENDING_SELECT_PLAN_6_MONTH);
        select10Month.click();
        Thread.sleep(300);
        String selectMonth = "images/ApplySoGoodUnsuccess/Selected 10 month.png";
        takeScreenshot(selectMonth);
        scenario.createNode(Given.class, "Selected plan 10 month.").addScreenCaptureFromPath(selectMonth).pass("pass");
        Thread.sleep(300);

        // Click Next to detail installment plan
        nextTransaction.click();
        ttbTestContext.waitUntilVisible(OneAppElementKeys.LENDING_DATA_TRANSACTION);
        String detailPlan = "images/ApplySoGoodUnsuccess/Detail installment plan.png";
        ...
        Thread.sleep(1000);
        ttbTestContext.verticalSwipeByPercentages(0.9, 0.3, 0.5);
        String dataSelected = "images/ApplySoGoodUnsuccess/Data selected.png";
        ...
        tncChecked.click();
        Thread.sleep(300);
        String checkTnC = "images/ApplySoGoodUnsuccess/checkTnC.png";
        ...
        // Click Next to Partial Successful
        nextTransaction.click();
        ...
        String successSoGood = "images/ApplySoGoodUnsuccess/successful.png";
        ...
        Assert.assertEquals(clickSoGood.getText(),"so goood successful");
        ...
        Thread.sleep(4000);
        String mainPage = "images/ApplySoGoodUnsuccess/mainPage.png";
        ...
        String unBilled = "images/ApplySoGoodUnsuccess/CheckUnBilled.png";
