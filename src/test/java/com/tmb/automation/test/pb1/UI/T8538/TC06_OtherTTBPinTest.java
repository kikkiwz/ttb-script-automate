package com.tmb.automation.test.pb1.UI.T8538;
...
public class TC06_OtherTTBPinTest extends Base {
	...
	public Object[][] getExcelData() throws IOException {
		Object Data[][] = Helper.testadataDataprovider("TestData_pb1", "OtherTMB");
		return Data;
	}

	@Test(groups = { "android", "PB1" }, dataProvider = "getExcelData", description = "Other TTB Transfer")
	public void Test001(String aa1, String bb1, String cc1) throws InterruptedException, IOException {
		...
		if (toBankCode.equals("11")) {
			pb1.SelectBBL().click();
			pb1.SelectOtherToAcNo().click();
			pb1.SelectOtherTTB().click();
			Thread.sleep(2000);
		} else {
			System.out.println("----------- Wrong Bank Code, Try again with correct TTB Bank Code ---------");
		}
		...
		pb1.TypeAmount().sendKeys("111.00");
		Thread.sleep(2000);
		appiumDriver.hideKeyboard();
		...
		PB1PinAndroid.LoginTransfer(); // Call pin method
