...
public class API_TC06_VerifyStatusPass extends Base {
	...
	@Test(groups = { "android", "PB1" }, description = "VerifyStatus Pass")
...
//				.post(VerifyStatus).then().assertThat().statusCode(200).extract().response();
//
...
//		
//		System.out.println("///////////Verify Status Passed/////////////// ");				
		}
