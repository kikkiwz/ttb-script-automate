...
public class SetScheduleOtherBankWeeklyByTimesScenario extends PrimaryBanking3Base {
    String fromAccountNumber;
    String toAccountNumber;
    String scheduleName;
    String scheduleAmountOfTimes;

    @Test(groups = "Set schedule other bank weekly amount of times", priority = 1)
    ...
    @Test(groups = "Set schedule other bank weekly amount of times", priority = 2)
    ...
    @Test(groups = "Set schedule other bank weekly amount of times", priority = 3)
    ...
    @Test(groups = "Set schedule other bank weekly amount of times", priority = 4)
    ...
    @Test(groups = "Set schedule other bank weekly amount of times", priority = 5)
