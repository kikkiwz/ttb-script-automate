...
public class Pb2iOSOneAppElements {

    private Pb2iOSOneAppElements() {

    }

    //PB2
    private static final OneAppElement PRIMARY_BANKING2_DEPOSIT_ACCOUNT_LIST = new OneAppElement(FindBy.XPATH, "//XCUIElementTypeScrollView/XCUIElementTypeOther/XCUIElementTypeTable/XCUIElementTypeCell[2]");
    private static final OneAppElement PRIMARY_BANKING2_ACCOUNT_NICKNAME = new OneAppElement(FindBy.XPATH, "//XCUIElementTypeOther[@name='ONEAPP']/XCUIElementTypeOther[9]/XCUIElementTypeOther[1]/XCUIElementTypeStaticText");
    private static final OneAppElement PRIMARY_BANKING2_SEARCH_ACTIVITY = new OneAppElement(FindBy.XPATH, "//XCUIElementTypeOther[@name='ONEAPP']/XCUIElementTypeOther[118]/XCUIElementTypeButton");
    private static final OneAppElement PRIMARY_BANKING2_SEARCH_FIELD = new OneAppElement(FindBy.XPATH, "//XCUIElementTypeOther[@name='ONEAPP']/XCUIElementTypeTextField");
    private static final OneAppElement PRIMARY_BANKING2_SEARCH_BUTTON = new OneAppElement(FindBy.XPATH, "//XCUIElementTypeOther[@name=\"ONEAPP\"]/XCUIElementTypeButton[3]");
    private static final OneAppElement PRIMARY_BANKING2_ACTIVITY_DATE_TITLE = new OneAppElement(FindBy.XPATH, "//XCUIElementTypeOther[@name=\"ONEAPP\"]/XCUIElementTypeOther[123]/XCUIElementTypeStaticText");
    private static final OneAppElement PRIMARY_BANKING2_EXPEND_ACTIVITY = new OneAppElement(FindBy.XPATH, "//XCUIElementTypeOther[@name=\"ONEAPP\"]/XCUIElementTypeOther[127]");
    private static final OneAppElement PRIMARY_BANKING2_ACTIVITY_TRANSFER_TITLE = new OneAppElement(FindBy.XPATH, "//XCUIElementTypeOther[@name=\"ONEAPP\"]/XCUIElementTypeOther[124]");
    private static final OneAppElement PRIMARY_BANKING2_TRANSFEROUT_BEFOREAMOUNT = new OneAppElement(FindBy.XPATH, "//XCUIElementTypeOther[@name=\"ONEAPP\"]/XCUIElementTypeOther[125]/XCUIElementTypeStaticText");
    private static final OneAppElement PRIMARY_BANKING2_TRANSFEROUT_AMOUNT = new OneAppElement(FindBy.XPATH, "//XCUIElementTypeOther[@name=\"ONEAPP\"]/XCUIElementTypeOther[125]/XCUIElementTypeStaticText[2]");
    private static final OneAppElement PRIMARY_BANKING2_TRANSFEROUT_DATE = new OneAppElement(FindBy.XPATH, "//XCUIElementTypeOther[@name=\"ONEAPP\"]/XCUIElementTypeOther[126]");
    private static final OneAppElement PRIMARY_BANKING2_TRANSFEROUT_FROMAC = new OneAppElement(FindBy.XPATH, "//XCUIElementTypeOther[@name=\"ONEAPP\"]/XCUIElementTypeOther[131]/XCUIElementTypeStaticText");
    private static final OneAppElement PRIMARY_BANKING2_TRANSFEROUT_TOAC = new OneAppElement(FindBy.XPATH, "//XCUIElementTypeOther[@name=\"ONEAPP\"]/XCUIElementTypeOther[133]/XCUIElementTypeStaticText");
    private static final OneAppElement PRIMARY_BANKING2_TRANSFEROUT_CHANNEL = new OneAppElement(FindBy.XPATH, "//XCUIElementTypeOther[@name=\"ONEAPP\"]/XCUIElementTypeOther[135]/XCUIElementTypeStaticText");
    private static final OneAppElement PRIMARY_BANKING2_TRANSFEROUT_SEEDETAILS = new OneAppElement(FindBy.XPATH, "//XCUIElementTypeOther[@name=\"ONEAPP\"]/XCUIElementTypeButton[6]");
    private static final OneAppElement PRIMARY_BANKING2_TRANSFERIN_BEFOREAMOUNT = new OneAppElement(FindBy.XPATH, "//XCUIElementTypeOther[@name=\"ONEAPP\"]/XCUIElementTypeOther[125]/XCUIElementTypeStaticText");
    private static final OneAppElement PRIMARY_BANKING2_TRANSFERIN_AMOUNT = new OneAppElement(FindBy.XPATH, "//XCUIElementTypeOther[@name=\"ONEAPP\"]/XCUIElementTypeOther[125]/XCUIElementTypeStaticText[2]");
    private static final OneAppElement PRIMARY_BANKING2_TRANSFERIN_DATE = new OneAppElement(FindBy.XPATH, "//XCUIElementTypeOther[@name=\"ONEAPP\"]/XCUIElementTypeOther[126]");
    private static final OneAppElement PRIMARY_BANKING2_TRANSFERIN_CHANNEL = new OneAppElement(FindBy.XPATH, "//XCUIElementTypeOther[@name=\"ONEAPP\"]/XCUIElementTypeOther[130]/XCUIElementTypeStaticText");
    private static final OneAppElement PRIMARY_BANKING2_TRANSFERIN_SEEDETAILS = new OneAppElement(FindBy.XPATH, "//XCUIElementTypeOther[@name='ONEAPP']/XCUIElementTypeButton[5]");
    private static final OneAppElement PRIMARY_BANKING2_ACTIVITY_BACKBUTTON = new OneAppElement(FindBy.XPATH, "//XCUIElementTypeButton[@name='Back ButtonBack']");
    private static final OneAppElement PRIMARY_BANKING2_MORE_MENU = new OneAppElement(FindBy.XPATH, "//XCUIElementTypeOther[@name='ONEAPP']/XCUIElementTypeOther[12]/XCUIElementTypeOther[4]");
    private static final OneAppElement PRIMARY_BANKING2_STATEMENT_MENU = new OneAppElement(FindBy.XPATH, "//XCUIElementTypeOther[@name=\"ONEAPP\"]/XCUIElementTypeOther[117]/XCUIElementTypeStaticText");
    private static final OneAppElement PRIMARY_BANKING2_STATEMENT_BUTTON = new OneAppElement(FindBy.XPATH, "//XCUIElementTypeOther[@name=\"ONEAPP\"]/XCUIElementTypeOther[118]/XCUIElementTypeOther[2]/XCUIElementTypeOther");
    private static final OneAppElement PRIMARY_BANKING2_REQUEST_STATEMENT_TITLE = new OneAppElement(FindBy.XPATH, "//XCUIElementTypeOther[@name='ONEAPP']/XCUIElementTypeOther[2]/XCUIElementTypeOther/XCUIElementTypeStaticText");
    private static final OneAppElement PRIMARY_BANKING2_SELECT_LANGUAGE_LABEL = new OneAppElement(FindBy.XPATH, "//XCUIElementTypeOther[@name='ONEAPP']/XCUIElementTypeOther[3]/XCUIElementTypeStaticText");
    private static final OneAppElement PRIMARY_BANKING2_SELECT_LANGUAGE_TH_RADIO_BUTTON = new OneAppElement(FindBy.XPATH, "//XCUIElementTypeOther[@name=\"ONEAPP\"]/XCUIElementTypeOther[4]");
    private static final OneAppElement PRIMARY_BANKING2_SELECT_LANGUAGE_EN_RADIO_BUTTON = new OneAppElement(FindBy.XPATH, "//XCUIElementTypeOther[@name=\"ONEAPP\"]/XCUIElementTypeOther[5]");
    private static final OneAppElement PRIMARY_BANKING2_STATEMENT_CONDENSED_STATEMENT_RADIO_BUTTON = new OneAppElement(FindBy.XPATH, "//XCUIElementTypeOther[@name=\"ONEAPP\"]/XCUIElementTypeOther[8]");
    private static final OneAppElement PRIMARY_BANKING2_STATEMENT_DETAILS_STATEMENT_RADIO_BUTTON = new OneAppElement(FindBy.XPATH, "//XCUIElementTypeOther[@name=\"ONEAPP\"]/XCUIElementTypeOther[9]");
    private static final OneAppElement PRIMARY_BANKING2_TRANSACTION_PERIOD_FROM_BUTTON = new OneAppElement(FindBy.XPATH, "//XCUIElementTypeOther[@name=\"ONEAPP\"]/XCUIElementTypeOther[12]/XCUIElementTypeOther[1]");
    private static final OneAppElement PRIMARY_BANKING2_TRANSACTION_PERIOD_TO_BUTTON = new OneAppElement(FindBy.XPATH, "//XCUIElementTypeOther[@name=\"ONEAPP\"]/XCUIElementTypeOther[13]/XCUIElementTypeOther[1]");
    private static final OneAppElement PRIMARY_BANKING2_SELECT_MONTH7 = new OneAppElement(FindBy.XPATH, "//XCUIElementTypePicker/XCUIElementTypePickerWheel");
    private static final OneAppElement PRIMARY_BANKING2_SELECT_MONTH6 = new OneAppElement(FindBy.XPATH, "//XCUIElementTypePicker/XCUIElementTypePickerWheel");
    private static final OneAppElement PRIMARY_BANKING2_GENERATE_STATEMENT_BUTTON = new OneAppElement(FindBy.XPATH, "//XCUIElementTypeOther[@name=\"ONEAPP\"]/XCUIElementTypeButton");
    private static final OneAppElement PRIMARY_BANKING2_EXCEEDS_6MONTHS_TITLE = new OneAppElement(FindBy.XPATH, "//XCUIElementTypeOther[@name=\"ONEAPP\"]/XCUIElementTypeOther[3]/XCUIElementTypeStaticText");
    private static final OneAppElement PRIMARY_BANKING2_EXCEEDS_6MONTHS_DETAILS = new OneAppElement(FindBy.XPATH, "//XCUIElementTypeOther[@name=\"ONEAPP\"]/XCUIElementTypeOther[4]/XCUIElementTypeStaticText");
    private static final OneAppElement PRIMARY_BANKING2_EXCEEDS_6MONTHS_OK_BUTTON = new OneAppElement(FindBy.XPATH, "//XCUIElementTypeOther[@name=\"ONEAPP\"]/XCUIElementTypeOther[5]/XCUIElementTypeButton");
    private static final OneAppElement PRIMARY_BANKING2_STATEMENT_PAGE_LABEL = new OneAppElement(FindBy.XPATH, "//XCUIElementTypeOther[@name='ONEAPP']/XCUIElementTypeOther[2]/XCUIElementTypeOther/XCUIElementTypeStaticText");
    private static final OneAppElement PRIMARY_BANKING2_STATEMENT_SAVE_FILE_BUTTON = new OneAppElement(FindBy.XPATH, "//XCUIElementTypeOther[@name=\"ONEAPP\"]/XCUIElementTypeButton");
    private static final OneAppElement PRIMARY_BANKING2_STATEMENT_SHARE_FILE_BUTTON = new OneAppElement(FindBy.XPATH, "//XCUIElementTypeOther[@name=\"ONEAPP\"]/XCUIElementTypeButton[2]");
    private static final OneAppElement PRIMARY_BANKING2_STATEMENT_BACKBUTTON = new OneAppElement(FindBy.XPATH, "//XCUIElementTypeButton[@name='medium-chevron-left']");
    private static final OneAppElement PRIMARY_BANKING2_KEYPAD_DONE = new OneAppElement(FindBy.XPATH, "//XCUIElementTypeButton[@label='Done']");


    //PB2 - Setting PromptPay
    private static final OneAppElement PRIMARY_BANKING2_PROMPTPAY_EXAMPlE_SCREEN = new OneAppElement(FindBy.ACCESSIBILITY_ID, "Done");
    ...
    private static final OneAppElement PRIMARY_BANKING2_PROMPTPAY_SIGNED_UP_CITIZEN_ID_GREEN_LOGO = new OneAppElement(FindBy.XPATH,"(//div[@id='spLb_signed_up_label'])[2]");
    ...
    private static final OneAppElement PRIMARY_BANKING2_PROMPTPAY_CITIZEN_ID_ALREADY_REGISTERED_LABEL = new OneAppElement(FindBy.XPATH,"(//*[@id='spLb_bank_desc_label'])[2]");
...
//PB2 - Manage Debit Card
    private static final OneAppElement PB2_HOM_ACCOUNT = FX("");
    private static final OneAppElement PB2_REG_P2_THAI = FC("XCUIElementTypeStaticText[value=\"ภาษาไทย\"]");
    private static final OneAppElement PB2_REG_P2_INPUT_FIELD = FC("XCUIElementTypeTextField[name=\"CID Input Field\"]");
    private static final OneAppElement PB2_REG_P3_NEXT = FC("XCUIElementTypeStaticText[name=\"ถัดไป\"]");
    private static final OneAppElement PB2_REG_P2_NEXT = FX("//XCUIElementTypeOther[XCUIElementTypeButton[@name=\"iconCheck\"]]//XCUIElementTypeStaticText"); //XCUIElementTypeStaticText[name="Next"]
    private static final OneAppElement PB2_REG_P4_OTP1 = FC("XCUIElementTypeTextField[name=\"OTPTextField1\"]");
    private static final OneAppElement PB2_REG_P5_NOTI_ALLOW = FA("Allow");
    private static final OneAppElement PB2_HOM_GUIDELINE_NEXT = FX("//XCUIElementTypeApplication[1]/XCUIElementTypeWindow[1]/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeButton");
    private static final OneAppElement PB2_ACC_GUIDELINE_DONE = FX("//XCUIElementTypeApplication[1]/XCUIElementTypeWindow[1]/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeButton");
    private static final OneAppElement PB2_PIN1 = FC("XCUIElementTypeStaticText[label =\"1\"]");
    private static final OneAppElement PB2_PIN2 = FC("XCUIElementTypeStaticText[label =\"2\"]");
    private static final OneAppElement PB2_PIN3 = FC("XCUIElementTypeStaticText[label =\"3\"]");
    private static final OneAppElement PB2_PIN4 = FC("XCUIElementTypeStaticText[label =\"4\"]");
    private static final OneAppElement PB2_PIN5 = FC("XCUIElementTypeStaticText[label =\"5\"]");
    private static final OneAppElement PB2_PIN6 = FC("XCUIElementTypeStaticText[label =\"6\"]");
    private static final OneAppElement PB2_PIN7 = FC("XCUIElementTypeStaticText[label =\"7\"]");
    private static final OneAppElement PB2_PIN8 = FC("XCUIElementTypeStaticText[label =\"8\"]");
    private static final OneAppElement PB2_PIN9 = FC("XCUIElementTypeStaticText[label =\"9\"]");
    private static final OneAppElement PB2_PIN0 = FC("XCUIElementTypeStaticText[label =\"0\"]");
        private static final OneAppElement PB2_CONFIRM_PIN1 = FC("XCUIElementTypeStaticText[value=\"1\"]");
    private static final OneAppElement PB2_CONFIRM_PIN2 = FC("XCUIElementTypeStaticText[value=\"2\"]");
    private static final OneAppElement PB2_CONFIRM_PIN3 = FC("XCUIElementTypeStaticText[value=\"3\"]");
    private static final OneAppElement PB2_CONFIRM_PIN4 = FC("XCUIElementTypeStaticText[value=\"4\"]");
    private static final OneAppElement PB2_CONFIRM_PIN5 = FC("XCUIElementTypeStaticText[value=\"5\"]");
    private static final OneAppElement PB2_CONFIRM_PIN6 = FC("XCUIElementTypeStaticText[value=\"6\"]");
    private static final OneAppElement PB2_CONFIRM_PIN7 = FC("XCUIElementTypeStaticText[value=\"7\"]");
    private static final OneAppElement PB2_CONFIRM_PIN8 = FC("XCUIElementTypeStaticText[value=\"8\"]");
    private static final OneAppElement PB2_CONFIRM_PIN9 = FC("XCUIElementTypeStaticText[value=\"9\"]");
    private static final OneAppElement PB2_CONFIRM_PIN0 = FC("XCUIElementTypeStaticText[value=\"0\"]");
    private static final OneAppElement PB2_ACC_ACCOUNTS = FC("XCUIElementTypeTable > XCUIElementTypeCell");

    private static final OneAppElement PB2W_DET_LOADING = FC(".loading_loadingBox__2m_2X");
    private static final OneAppElement PB2W_DET_TITLE = FX("//div[contains(@class, \"style__NavigationWrapper\")]/div[1]/div[1]/div[1]/div[2]/div[1]");
