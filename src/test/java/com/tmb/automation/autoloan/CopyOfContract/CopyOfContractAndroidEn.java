...
public class CopyOfContractAndroidEn extends Base {
...
//		System.setProperty("webdriver.chrome.driver", filepath);
	...
	private void OpenServiceRequestList() throws InterruptedException {
		...
		System.out.println(phrasesConfigService.getValueEn(PhrasesConfigKey.AUTO_LOAN_KEY.lable_title_autoloan_request_list));
