...
import com.ttbbank.oneapp.scenario.investment.CannotOpenPortExistingTestScenario;
...
public class CannotOpenPortRunner extends CannotOpenPortExistingTestScenario {
    ...
    public void BeforeTest(@Optional String deviceProfile) throws MalformedURLException {
        ...
        ExtentTest feature = extentReports.createTest("Cannot Open Port");
        setFeature(feature);
