...
public class ActivityDetailsIOS extends BaseScenario {
	...
	public void BeforeTest(String deviceProfile) {
        ...
        ExtentReporter extentReporter = new ExtentHtmlReporter("reports/ActivityDetailsIOS.html");
        extentReports.attachReporter(extentReporter);
        ExtentTest feature = extentReports.createTest("ActivityDetailsIOS");
        setFeature(feature);
