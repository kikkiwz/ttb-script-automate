package com.tmb.automation.test.pb1.UI.T9258;
...
public class TC14_MobileTTBPinTest extends Base {
	...
	public Object[][] getExcelData() throws IOException {
		Object Data[][] = Helper.testadataDataprovider("TestData_pb1", "MobileTTB");
		return Data;
	}

	@Test(groups = { "android", "PB1" }, dataProvider = "getExcelData", description = "Mobile TTB Bank Transfer")
	public void Test001(String aa1, String bb1, String cc1) throws InterruptedException, IOException {
		...
		pb1.TypeAmount().sendKeys("124.00");
		Thread.sleep(2000);
		appiumDriver.hideKeyboard();
