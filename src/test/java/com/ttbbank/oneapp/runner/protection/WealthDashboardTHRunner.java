...
import com.ttbbank.oneapp.scenario.protection.WealthDashboardTHScenario;
...
public class WealthDashboardTHRunner extends WealthDashboardTHScenario {
    ...
    public void BeforeTest(@Optional String deviceProfile) throws MalformedURLException {
        ...
        ExtentListeners.setDriver(ttbTestContext.getDriver()); ExtentReports
                ...
                ExtentHtmlReporter("reports/Protection Wealth Dashboard_TH.html");
        extentReports.attachReporter(extentReporter); ExtentTest feature =
                extentReports.createTest("Wealth Dashboard"); setFeature(feature);
