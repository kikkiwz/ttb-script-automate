...
public class TopUpScheduleTrueWeeklyEndDateScenario extends PrimaryBanking7Base{
    String fromAccountNumber;
    String scheduleStartDate;
    String scheduleDayEvery;
    String scheduleEndDate;

    @Test(groups = "Topup schedule true weekly end date success", priority = 1)
    ...
    @Test(groups = "Topup schedule true weekly end date success", priority = 2)
    ...
    @Test(groups = "Topup schedule true weekly end date success", priority = 3)
    ...
    @Test(groups = "Topup schedule true weekly end date success", priority = 4)
    public void testToggleSetScheduleAndEnterDetail() throws IOException {
        ...
        context.findElement(OneAppElementKeys.PB7_KEY_BOARD_TWO).click();
        context.findElement(OneAppElementKeys.PB7_KEYPAD_DONE).click();
        ...
        context.findElement(OneAppElementKeys.PB7_TOPUP_SCHEDULE_SELECT_WEEKLY).click();
        context.findElement(OneAppElementKeys.PB7_TOPUP_SCHEDULE_ENDDATE_PICKER_AMOUNT).click();
        context.findElement(OneAppElementKeys.PB7_KEYPAD_DONE).click();
        scheduleEndDate = context.findElement(OneAppElementKeys.PB7_TOPUP_SCHEDULE_ENDDATE_PICKER_AMOUNT).getText();
        scheduleDayEvery = context.findElement(OneAppElementKeys.PB7_TOPUP_SCHEDULE_DAY_EVERY_AMOUNT).getText();

        createScreenShot("Show enter detail screen filled information", true);
    }

    @Test(groups = "Topup schedule true weekly end date success", priority = 5)
    ...
    public void testValidateScheduleReviewInfo() throws IOException {
        ...
        evaluateAssertEqual(
                context.findElement(OneAppElementKeys.PB7_TOPUP_SCHEDULE_SCHEDULE_NAME_TRUE_WEEKLY).getText(),
                "Test 02",
    ...
    @Test(groups = "Topup schedule true weekly end date success", priority = 7)
