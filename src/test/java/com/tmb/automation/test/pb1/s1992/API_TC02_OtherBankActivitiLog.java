package com.tmb.automation.test.pb1.s1992;
...
public class API_TC02_OtherBankActivitiLog extends Base {
	...
	@Test(groups = {"android", "PB1"}, dataProvider="getExcelData", description="Other Bank Transfer Log")
...
//Verify Activity log in Oracle DB --------------------------------------------------		
		...
		while (result1.next()) {
			...
			Assert.assertEquals("025", activityTypeDB, "ACTIVITY_TYPE_ID");
			...
			Assert.assertEquals("P", smartFlagDB, "SMART_FLAG validated");
			...
			Assert.assertEquals("00", idTypeDB, "ANY_ID_TYPE validated");
			...
			Assert.assertEquals("100400300", activityTypeNewDB, "ACTIVITY_TYPE_ID_NEW");
