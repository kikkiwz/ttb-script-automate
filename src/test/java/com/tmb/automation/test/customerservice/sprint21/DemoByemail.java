...
public class DemoByemail extends Base{
    ...
    public void TS_ONEAPP_4514_EN_ASTTutorial_SIT_00003() throws Exception {
        ...
        MobileElement Email = appiumDriverMobile.findElement(By.xpath("//*[@resource-id='request_ncb_email_id']"));
        String elEmail = Email.getText();
        MobileElement EmailValue = appiumDriverMobile.findElement(By.xpath("//*[@resource-id='request_ncb_report_edit_post_profile_email_desc_id']"));
        ...
        Assert.assertTrue(elIDNumberValue.equals(JsonData.get("national_id")));
        ...
        Assert.assertTrue(elNote.equals("Should e-credit report not successfully sent to your e-mail, Credit Bureau will send credit report paper to your delivery address within 7 working days."));
    ...
    public void TS_ONEAPP_4514_EN_ASTTutorial_SIT_00005() throws Exception {
        ...
        MobileElement Money = appiumDriverMobile.findElement(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.FrameLayout/android.widget.FrameLayout/android.view.ViewGroup/android.view.ViewGroup/androidx.viewpager.widget.ViewPager/androidx.recyclerview.widget.RecyclerView/android.widget.FrameLayout/android.widget.FrameLayout/android.webkit.WebView/android.webkit.WebView/android.view.View/android.view.View[4]/android.view.View/android.widget.TextView[3]"));
        String elMoney = Money.getText().replaceAll(",","");
        ...
        System.err.println("elMoney :" + elMoney);
        ...
        Assert.assertTrue(elMoney.equals(Arr_Acc_list.get("currentBalance")));
    ...
    public void TS_ONEAPP_4514_EN_ASTTutorial_SIT_00006() throws Exception {
        ...
        System.err.println("elEmail : " + elEmail);
        System.err.println("elLabelEmail : " + elLabelAddress);
...
//        Assert.assertTrue(elLabelMobileNumber.equals("Mobile Number"));
        ...
        Assert.assertTrue(elNote.equals("Credit report will be sent via e-mail within 24 hours."));
...
//        scrollUPANDDOWN(0.5, 0.8, 0.5, 0.2); // down
    ...
    public void TS_ONEAPP_4514_EN_ASTTutorial_SIT_00007() throws Exception {
        ...
        Assert.assertTrue(elSuccessDetail.equals("Credit report will be sent by e-mail within 24 hrs. from e-report@ncb.co.th. If you don’t find e-mail in your inbox, please check your junk mail."));
