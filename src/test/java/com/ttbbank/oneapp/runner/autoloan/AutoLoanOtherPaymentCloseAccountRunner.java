...
public class AutoLoanOtherPaymentCloseAccountRunner extends AutoLoanOtherPaymentCloseAccountScenario {
    ...
    public void BeforeTest(@Optional String deviceProfile) throws MalformedURLException {
        ...
        ExtentReporter extentReporter = new ExtentHtmlReporter("reports/Other_Payment_Close_Account_"+ttbTestContext.getPlateFormName()+".html");
