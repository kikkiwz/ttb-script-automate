...
import com.ttbbank.oneapp.scenario.protection.PolicyDetailsScenario;
...
public class PolicyDetailsRunner extends PolicyDetailsScenario {
    ...
    public void BeforeTest(@Optional String deviceProfile) throws MalformedURLException {
        ...
        ExtentListeners.setDriver(ttbTestContext.getDriver()); ExtentReports
                ...
                ExtentHtmlReporter("reports/Protection Policy Details.html");
        extentReports.attachReporter(extentReporter); ExtentTest feature =
                extentReports.createTest("Policy Details"); setFeature(feature);
