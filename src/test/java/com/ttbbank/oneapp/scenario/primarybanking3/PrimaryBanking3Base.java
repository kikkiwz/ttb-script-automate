package com.ttbbank.oneapp.scenario.primarybanking3;
...
public class PrimaryBanking3Base extends BaseScenario {
    private ExtentTest scenario;
    private ExtentTest scnLog;
    private Boolean scenarioIsFail = false;

    private String testName;
    private String pathToReport = "reports/pb3";
    private String pathToImage = "images/pb3";
    ...
    public void pressKeyBoardWithString(String text) {
        TtbTestContext context = getTtbTestContext();

        for(int i = 0; i < text.length(); i++) {
            char textChar = text.charAt(i);
            context.findElement("PB3_KEY_BOARD_" + Character.toUpperCase(textChar) + "_BUTTON").click();
        }
    }
