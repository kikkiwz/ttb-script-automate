...
import com.ttbbank.oneapp.scenario.protection.WealthDashboardScenario;
...
public class WealthDashboardRunner extends WealthDashboardScenario {
    ...
    public void BeforeTest(@Optional String deviceProfile) throws MalformedURLException {
        ...
        ExtentListeners.setDriver(ttbTestContext.getDriver()); ExtentReports
                ...
                ExtentHtmlReporter("reports/Protection Wealth Dashboard.html");
