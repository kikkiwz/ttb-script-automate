...
public class API_TC15_ActivityLogSelectBank extends Base {
...
//ekYC Activity Log ----------------------------------------------------
		...
		String Input1 = "Select Bank and send request to verify";
		String Input2 = "eKYC";
		String Input3 = "BKK SCB KTB etc";
		String Input4 = "Pending";
		...
		hmC1.put("request_type", Input2);
		hmC1.put("bank", Input3);
		hmC1.put("request_status", Input4);
...
//Verify in ccweb ------------------------------------------------------------------
		...
		Assert.assertEquals(Details1a, "eKYC Step = "+Input1);
		Assert.assertEquals(Details1b, "Request Type = "+Input2);
		Assert.assertEquals(Details1c, "Bank = "+Input3);
		Assert.assertEquals(Details1d, "Request Status = "+Input4);
