...
public class SetScheduleOtherBankMonthlyByTimesScenario extends PrimaryBanking3Base {
    ...
    @Test(groups = "Set schedule other bank monthly amount of times", priority = 1)
    ...
    @Test(groups = "Set schedule other bank monthly amount of times", priority = 2)
    ...
    @Test(groups = "Set schedule other bank monthly amount of times", priority = 3)
    ...
    @Test(groups = "Set schedule other bank monthly amount of times", priority = 4)
    ...
    @Test(groups = "Set schedule other bank monthly amount of times", priority = 5)
