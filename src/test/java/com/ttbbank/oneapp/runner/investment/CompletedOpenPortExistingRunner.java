...
import com.ttbbank.oneapp.scenario.investment.CompletedOpenPortExistingTestScenario;
import com.ttbbank.oneapp.scenario.investment.CompletedOpenPortTestScenario;
...
public class CompletedOpenPortExistingRunner extends CompletedOpenPortExistingTestScenario {
    ...
    public void BeforeTest(@Optional String deviceProfile) throws MalformedURLException {
        ...
        ExtentTest feature = extentReports.createTest("Completed Open Portfolio Existing");
        setFeature(feature);
