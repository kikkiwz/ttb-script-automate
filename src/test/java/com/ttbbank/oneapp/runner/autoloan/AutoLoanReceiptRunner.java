...
public class AutoLoanReceiptRunner extends AutoLoanReceiptScenario {
    ...
    public void BeforeTest(@Optional String deviceProfile) throws MalformedURLException {
        ...
        ExtentReporter extentReporter = new ExtentHtmlReporter("reports/ReceiptTaxInvoice_"+ttbTestContext.getPlateFormName()+".html");
