...
public class SetScheduleWeeklyByEndDateScenario extends PrimaryBanking3Base {
    ...
    @Test(groups = "Set schedule weekly by end date", priority = 1)
    ...
    @Test(groups = "Set schedule weekly by end date", priority = 2)
    ...
    @Test(groups = "Set schedule weekly by end date", priority = 3)
    public void testFilledSetscheduleEnterDetailAndNextToReviewScreenSuccess() throws IOException {
        ...
        context.findElement(OneAppElementKeys.PB3_SCHEDULE_FREQUENCY_ENDDATE_TEXTFIELD).click();
        context.findElement(OneAppElementKeys.PB3_KEYPAD_DONE).click();
        scheduleEndDate = context.findElement(OneAppElementKeys.PB3_SCHEDULE_FREQUENCY_ENDDATE_TEXTFIELD).getText();
        scheduleDayEvery = context.findElement(OneAppElementKeys.PB3_SCHEDULE_FREQUENCY_DAY_EVERY).getText();
    ...
    @Test(groups = "Set schedule weekly by end date", priority = 4)
    ...
    @Test(groups = "Set schedule weekly by end date", priority = 5)
