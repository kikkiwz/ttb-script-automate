...
public class API_TC08_CitizenIDActivityLog extends Base {
	...
	public  Object[][] getExcelData() throws IOException 	{
		 Object Data[][]=Helper.testadataDataprovider("TestData_pb1", "Citizen"); 
		return Data; 	}
...
//Verify Activity log in Oracle DB --------------------------------------------------	
		...
		while (result1.next()) {
			...
			Assert.assertEquals("607", activityTypeDB, "ACTIVITY_TYPE_ID");
			...
			Assert.assertEquals("100400700", activityTypeNewDB, "ACTIVITY_TYPE_ID_NEW");
