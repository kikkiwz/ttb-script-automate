...
public class ApplyMenuActivatedDepositScenario extends BaseScenario {
    @Test(groups = "Customer Service Apply Menu Activated Deposit", dependsOnGroups = {"Enter Home Screen Dev Latest","Enter Service Screen Dev Latest"})
