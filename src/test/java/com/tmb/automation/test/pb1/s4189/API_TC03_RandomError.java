package com.tmb.automation.test.pb1.s4189;
...
public class API_TC03_RandomError extends Base {
	...
	@Test(groups = {"android", "PB1"}, dataProvider="getExcelData", description="Random Error")
...
//Data Input -----------------------------------------------------------------------------------
		...
		String toAccountNo = "2242117295"; //Input to account transfer to dream account
...
//Transfer and Validation -------------------------------------------------------------------
		...
		JsonPath js2=new JsonPath(responseString1); //for parsing Json
		String codeV2=js2.getString("status.code");
		String CodeExpected2= "cbs_8897";
		...
		String messageexpected2 = "fg2103?tsfgpfg1 resp. error       ?                        ";
		...
		System.out.println("///////////Transfer Validated Success/////////////// ");		
}
