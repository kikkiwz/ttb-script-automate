...
import com.ttbbank.oneapp.scenario.investment.InformationOpenPortExistingTestScenario;
import com.ttbbank.oneapp.scenario.investment.InformationOpenPortTestScenario;
...
public class InformationOpenPortExistingRunner extends InformationOpenPortExistingTestScenario {
    ...
    public void BeforeTest(@Optional String deviceProfile) throws MalformedURLException {
        ...
        ExtentTest feature = extentReports.createTest("Information Open Portfolio");
        setFeature(feature);
