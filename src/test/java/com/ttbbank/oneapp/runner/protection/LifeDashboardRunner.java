...
import com.ttbbank.oneapp.scenario.protection.LifeDashboardScenario;
...
public class LifeDashboardRunner extends LifeDashboardScenario {
    ...
    public void BeforeTest(@Optional String deviceProfile) throws MalformedURLException {
        ...
        ExtentListeners.setDriver(ttbTestContext.getDriver()); ExtentReports
                ...
                ExtentHtmlReporter("reports/Protection Life Dashboard.html");
        extentReports.attachReporter(extentReporter); ExtentTest feature =
                extentReports.createTest("Life Dashboard"); setFeature(feature);
