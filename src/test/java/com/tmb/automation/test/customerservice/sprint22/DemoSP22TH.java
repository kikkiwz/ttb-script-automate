...
public class DemoSP22TH extends Base {
...
//                Assert.assertTrue(elNameAdvisor.equals(License.get("license_number"));
                ...
                Assert.assertTrue(elLicense2.equals(License.get("license_value_th")));
//                Assert.assertTrue(elNameAdvisor.equals(License.get("license_value_th"));
                Assert.assertTrue(elLicense2No.equals("เลขที่ใบอนุญาต " + License.get("license_number")));
                System.err.println("License no. " + License.get("license_number"));
                System.err.println("License no. " + License.get("license_value_th"));

            } else if (i == 2) {
                Assert.assertTrue(elLicense3.equals(License.get("license_value_th")));
//                Assert.assertTrue(elNameAdvisor.equals(License.get("license_value_th"));
                Assert.assertTrue(elLicense3No.equals("เลขที่ใบอนุญาต " + License.get("license_number")));
                System.err.println("License no. " + License.get("license_number"));
                System.err.println("License no. " + License.get("license_value_th"));
            } else {
                Assert.assertTrue(elLicense4.equals(License.get("license_value_th")));
//                Assert.assertTrue(elNameAdvisor.equals(License.get("license_value_th"));
                Assert.assertTrue(elLicense4No.equals("เลขที่ใบอนุญาต " + License.get("license_number")));
                System.err.println("License no. " + License.get("license_number"));
                System.err.println("License no. " + License.get("license_value_th"));
            }
        }
        Boolean within_working_hours = (Boolean) JsonDataEligibility.get("within_working_hours");
    }
