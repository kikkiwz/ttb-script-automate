...
public class API_TC05_ActivityLogCreatePINMatch extends Base {
...
//ekYC Activity Log ----------------------------------------------------
		...
		String Input1 = "Step (15/16) : eKYC - Create PIN";
		String Input2 = "Match";
		String Input3 = "Pass";
		...
		hmC1.put("confirm_pin_result", Input2);
		hmC1.put("confirm_pin_status", Input3);
...
//Verify in ccweb ------------------------------------------------------------------
		...
		Assert.assertEquals(Details1a, "Step (15/16) = "+Input1);
		Assert.assertEquals(Details1b, "Confirm PIN Result = "+Input2);
		Assert.assertEquals(Details1c, "Confirm PIN Status = "+Input3);
