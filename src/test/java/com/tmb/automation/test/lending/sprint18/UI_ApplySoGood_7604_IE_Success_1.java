...
public class UI_ApplySoGood_7604_IE_Success_1 extends Base {
    private final String JSONPATH = "LendingResources/json/ApplySoGood.json";
    private Map<String, Object> hashMap = LendingTestLib.convertJsonToMap("LendingResources/json/ApplySoGood.json");
    @Parameters({"DeviceProfile" })
    @BeforeMethod(groups = {"ios", "lending", "Sprint15", "1309"})
    public void BeforeTest(String deviceProfile) {  	
    	 Helper.CONFIG_PROFILE =deviceProfile;
        //LendingTestLib.setiOS();
    ...
    public void ADTest001() throws IOException {
        ...
        sleep(10);
        ld.assertText(ld.fX(ld.swAP5_title).getText(), "so goood successful");//so goood successful
