...
public class UI_ActivateCard_s1309_AE_1 extends Base {
//	protected static Map<String, String> mapData;
	@Parameters({"DeviceProfile" })
	@BeforeMethod(groups= {"lending"})
	...
	public void ADTest001() throws IOException {
		LendingTestLib.log("------------Start "+this.getClass().getSimpleName());
//		LendingTestLib.goHomeScreen("Account", "010203");
		...
		LendingTestLib.log("Enter Reference Number= "+mapData.get("Invalid_Ref_Number"));
		...
		LendingTestLib.log("Click Submit button");
