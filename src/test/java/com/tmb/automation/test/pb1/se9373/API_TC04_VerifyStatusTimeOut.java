...
public class API_TC04_VerifyStatusTimeOut extends Base {
	...
	@Test(groups = { "android", "PB1" }, description = "VerifyStatus Time Out")
...
//		System.out.println("///////////Waiting for 60 Mins/////////////// ");
//		Thread.sleep(360000);
//		
...
//		String CodeExpectedV11 = "ekyc_ndid_0003";
...
//		String messageexpectedV1 = "request ndid is not confirmed. (timeout)";
...
//		
//		System.out.println("///////////Verify Status Timeout Passed/////////////// ");	
	}
