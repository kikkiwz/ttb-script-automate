...
public class TC_936_IT_406 extends Base {
...
//		//Verify valid PIN success
		...
		hs.assertText(Otp_TutanotaPage.titleEmail_EN, map("Title_Email_ios"));
		hs.assertText(Otp_TutanotaPage.contentEmail_EN, map("Content_Email"));
		hs.assertText(Otp_TutanotaPage.titleEmail_TH, map("Title_Email_ios_TH"));
