package com.tmb.automation.test.pb1.UI.T11021;
...
public class TC12_CitizenOtherBankPinTest extends Base {
	...
	@Test(groups = { "android", "PB1" }, dataProvider = "getExcelData", description = "CitizenID Other Bank Transfer")
	public void Test001(String aa1, String bb1, String cc1) throws InterruptedException, IOException {
		...
		pb1.EnterPromptPayNo().sendKeys(toAccountNo);
		Thread.sleep(2000);
		appiumDriver.hideKeyboard();

		pb1.AmountField().click();
		pb1.TypeAmount().sendKeys("123.00");
		Thread.sleep(2000);
		appiumDriver.hideKeyboard();
