...
import com.ttbbank.oneapp.scenario.protection.LandingScreenTHScenario;
...
public class LandingScreenTHRunner extends LandingScreenTHScenario {
    ...
    public void BeforeTest(@Optional String deviceProfile) throws MalformedURLException {
        ...
        ExtentListeners.setDriver(ttbTestContext.getDriver()); ExtentReports
                ...
                ExtentHtmlReporter("reports/Protection Landing screen TH.html");
        extentReports.attachReporter(extentReporter); ExtentTest feature =
                extentReports.createTest("Landing screen TH"); setFeature(feature);
