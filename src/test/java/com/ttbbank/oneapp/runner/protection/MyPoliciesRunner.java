...
import com.ttbbank.oneapp.scenario.protection.MyPoliciesScenario;
...
public class MyPoliciesRunner extends MyPoliciesScenario {
    ...
    public void BeforeTest(@Optional String deviceProfile) throws MalformedURLException {
		...
		ExtentHtmlReporter("reports/Protection My Policies.html");
		 extentReports.attachReporter(extentReporter); ExtentTest feature =
		 extentReports.createTest("My Policies"); setFeature(feature);
