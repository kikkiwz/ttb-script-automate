...
public class UI_ChangeLimit_s3123_AT_2 extends Base {
	...
	public void ADTest001() throws IOException {
		...
		UI_Lending_Common.navigateToUsageLimit();
...
//		ld.writeLog();
		...
		sleep();
		ld.setNative();
		ld.waitVisible(ld.saBtn_Change3_Date20);
		ld.click(ld.saBtn_Change3_Date20);
		ld.waitVisible(ld.saBtn_Change3_SetCalendar);
		ld.click(ld.saBtn_Change3_SetCalendar);
