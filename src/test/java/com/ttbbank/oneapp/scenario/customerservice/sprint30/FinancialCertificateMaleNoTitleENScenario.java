...
public class FinancialCertificateMaleNoTitleENScenario extends BaseScenario {
    ...
    @Test(groups = "Customer Service Financial Certificate no tile en gender male", dependsOnGroups = {"Activate new flow", "Enter Service Screen Dev Latest"})
    ...
    public void TC_Financial_Certificate_0002() throws InterruptedException, IOException {
        TtbTestContext ttbTestContext = getTtbTestContext();
        (new WebDriverWait(ttbTestContext.getDriver(), 30)).until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@id='customerservice_finalcial_cf_navigation_icon_id']")));
        ...
        Thread.sleep(2000);
        ttbTestContext.verticalSwipeByPercentages(0.2, 0.9, 0.5);
    ...
    public void TC_Financial_Certificate_0003() throws IOException, InterruptedException {
        ...
        eqParams.put("", "");
        response = client.get("/apis/customer/assets/deposit", eqParams, DepositResponse.class);
        ...
        portNumber = (ArrayList<String>) response.getData().mutual_fund_account_lists;
...
//        ttbTestContext.setContextToWebView(OneAppElementKeys.TITLE_CERTIFICATE_DETAIL_SCREEN_2, true);
        ...
        String LabelConditionChangeInformation = ttbTestContext.findElement(OneAppElementKeys.LABEL_CONDITION_CHANGE_INFORMATION).getText().replaceAll("/n", "");
        ...
        selectTitleOwner.selectByValue("Master.");
        ...
        String LabelTitle = ttbTestContext.findElement(OneAppElementKeys.PLACEHOLDER_TITLE_OWNER).getText();
        ...
        ExtentTest scenario = getFeature().createNode(Scenario.class, "TC_ONEAPP-12693_FinCertDetails_00001");
        scenario.createNode(Given.class, "<pre>Test Step Description : Verification On Financial Statement, Display \"Personal Information\"  If the owner doesn’t have an EN title and male gender \n" +
                "The drop-down title will list conditions filter the show by gender [male].</pre>");
        scenario.createNode(Given.class, "<pre>Expected Result : On Financial certificate, Display \"Personal Information\" the owner doesn’t have an EN title and male gender ,\n" +
                "The system shall show drop-down title list condition by gender [male]</pre>");
//        scenario.createNode(Given.class, "<pre>The system shall show drop-down title list condition by gender [male]</pre>" + allOption.get(1) + "\n" + allOption.get(2));

        String informationDetail = "images/informationDetail_" + ttbTestContext.getPlateFormName() + ".png";
        takeScreenshot(informationDetail);
        scenario.createNode(Given.class, "On Financial certificate, Display \"Personal Information\" the owner doesn’t have an EN title and male gender").addScreenCaptureFromPath(informationDetail).pass("Pass");


        ttbTestContext.verticalSwipeByPercentages(0.9, 0.1, 0.5);
        ttbTestContext.setContextToWebView(OneAppElementKeys.PLACEHOLDER_FIRST_NAME, true);
        ...
        ttbTestContext.setContextToWebView(OneAppElementKeys.LABEL_PERSON_INFORMATION, true);
        ...
        String informationDetail2 = "images/informationDetail_" + ttbTestContext.getPlateFormName() + ".png";
        ...
        Assert.assertTrue(AfterSelectTitle.equals("Master."));
        ...
        System.out.println("textTitle : " + PlaceHolderTitle);
    ...
    public void TC_Financial_Certificate_0005() throws Exception {
        ...
        scenario4.createNode(Given.class, "The system allow the customer to select one account from Deposit or MF and enable Next bีtton").addScreenCaptureFromPath(selectAccount6).pass("Pass");
    ...
    public void TC_Financial_Certificate_0006() throws Exception {
        ...
        Assert.assertTrue(AssetOwnerValue.equals("Master. " + firstName + middleName + lastName));
    ...
    public void TC_Financial_Certificate_0007() {
        ...
        System.err.println("BtnClose : " + BtnClose);
