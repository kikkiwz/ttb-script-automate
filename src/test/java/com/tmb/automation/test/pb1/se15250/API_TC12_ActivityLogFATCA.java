...
public class API_TC12_ActivityLogFATCA extends Base {
...
//ekYC Activity Log ----------------------------------------------------
		...
		String Input1 = "Step (5/16) : eKYC - Completed FATCA Question";
		String Input2 = "N";
...
//Verify in ccweb ------------------------------------------------------------------
		...
		Assert.assertEquals(Details1a, "Step (5/16) = "+Input1);
		Assert.assertEquals(Details1b, "Fatca Flag = "+Input2);
