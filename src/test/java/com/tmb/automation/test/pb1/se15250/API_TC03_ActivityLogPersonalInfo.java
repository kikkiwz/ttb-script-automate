...
public class API_TC03_ActivityLogPersonalInfo extends Base {
...
//ekYC Activity Log ----------------------------------------------------
		...
		String Input1 = "Step (14/16) : eKYC - Personal Info";
		String Input2 = "Pass";
		String Input3 = "1";
		...
		hmC1.put("cal_risk_status", Input2);
		hmC1.put("risk_level", Input3);
...
//Verify in ccweb ------------------------------------------------------------------
		...
		Assert.assertEquals(Details1a, "Step (14/16) = "+Input1);
		Assert.assertEquals(Details1b, "Calculate Risk Status = "+Input2);
		Assert.assertEquals(Details1c, "Risk Level = "+Input3);
