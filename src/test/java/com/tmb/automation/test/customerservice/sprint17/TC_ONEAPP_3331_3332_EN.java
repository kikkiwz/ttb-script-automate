...
public class TC_ONEAPP_3331_3332_EN extends Base {
    ...
    public void TC_ONEAPP_EN_3331_VPNoAcct_SIT_00001() throws Exception {
        ...
        Assert.assertTrue(elNoAccount.equals("You don't have any TTB bank account"));
        Assert.assertTrue(elOpenAccount.equals("Open bank account"));
    }
}
