...
public class SetScheduleOtherToOwnAccountOnceScenario extends PrimaryBanking3Base {
    String fromAccountNumber;
    String toAccountNumber;
    String scheduleName;
    String scheduleStartDate;

    @Test(groups = "Set schedule other transfer to own account once", priority = 1)
    ...
    @Test(groups = "Set schedule other transfer to own account once", priority = 2)
    ...
    @Test(groups = "Set schedule other transfer to own account once", priority = 3)
    ...
    @Test(groups = "Set schedule other transfer to own account once", priority = 4)
    ...
    @Test(groups = "Set schedule other transfer to own account once", priority = 5)
