...
public class API_TC07_CitizenTTBActivityLog extends Base {
	...
	public  Object[][] getExcelData() throws IOException 	{
		 Object Data[][]=Helper.testadataDataprovider("TestData_pb1", "CitizenTTB"); //Excel to get data. 1. Add file name with path in global property. 2. put path name and Sheet name in class
		return Data; 	}
	
	@Test(groups = {"android", "PB1"}, dataProvider="getExcelData", description="PromptPay CitizenID Log")
...
// Transfer Confirmation -------------------------------------------------------------		
		...
		Assert.assertEquals(proxyType2, "01", "proxyType validated");
...
//Verify Activity log in Oracle DB --------------------------------------------------	
		...
		while (result1.next()) {
			...
			Assert.assertEquals("606", activityTypeDB, "ACTIVITY_TYPE_ID");
			...
			Assert.assertEquals("01", idTypeDB, "ANY_ID_TYPE validated");
			...
			Assert.assertEquals("100400600", activityTypeNewDB, "ACTIVITY_TYPE_ID_NEW");
