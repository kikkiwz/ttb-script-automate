...
public class AutoLoanOtherPaymentTaxAndMotorScenario extends AutoLoanHomeScenario {
    @Test(groups = "Other Payment For Tax", dependsOnGroups = "Enter Loan Home")
    public void receiptTaxInvoice() throws InterruptedException, IOException {
        ...
        context.findElement(OneAppElementKeys.AUTO_LOAN_QR_TAX_PAYMENT_BTN).click();
