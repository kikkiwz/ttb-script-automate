...
public class VirtualPassbookScenario extends BaseScenario {
    ...
    public void TC_ONEAPP_10580_PBMFList_00001() throws Exception {
        ...
        try{
            ...
            Thread.sleep(5000);
            String tutorial = "images/VirtualPassbook_TutorialPassBook_" + ttbTestContext.getPlateFormName() + ".png";
    ...
    public void TC_ONEAPP_10582_PB_00001() throws Exception {
        ...
        String fundName1 = (response.getData().virtual_passbook_details.get(0).account_nick_name == null) ? response.getData().virtual_passbook_details.get(0).product_name_en : response.getData().virtual_passbook_details.get(0).account_nick_name;
        String fundName2 = (response.getData().virtual_passbook_details.get(1).account_nick_name == null) ? response.getData().virtual_passbook_details.get(1).product_name_en : response.getData().virtual_passbook_details.get(1).account_nick_name;
        String fundName3 = (response.getData().virtual_passbook_details.get(2).account_nick_name == null) ? response.getData().virtual_passbook_details.get(2).product_name_en : response.getData().virtual_passbook_details.get(2).account_nick_name;
        String fundName4 = (response.getData().virtual_passbook_details.get(3).account_nick_name == null) ? response.getData().virtual_passbook_details.get(3).product_name_en : response.getData().virtual_passbook_details.get(3).account_nick_name;
        String fundName5 = (response.getData().virtual_passbook_details.get(4).account_nick_name == null) ? response.getData().virtual_passbook_details.get(4).product_name_en : response.getData().virtual_passbook_details.get(4).account_nick_name;
        String fundName6 = (response.getData().virtual_passbook_details.get(5).account_nick_name == null) ? response.getData().virtual_passbook_details.get(5).product_name_en : response.getData().virtual_passbook_details.get(5).account_nick_name;
        String fundName7 = (response.getData().virtual_passbook_details.get(6).account_nick_name == null) ? response.getData().virtual_passbook_details.get(6).product_name_en : response.getData().virtual_passbook_details.get(6).account_nick_name;
        ...
        result = CheckResults(elBalance1, response.getData().virtual_passbook_details.get(0).branch_name_en, result);
        result = CheckResults(elAccountName2, fundName2, result);
        result = CheckResults(elBalance2, response.getData().virtual_passbook_details.get(1).branch_name_en, result);
        result = CheckResults(elAccountName3, fundName3, result);
        result = CheckResults(elBalance3, response.getData().virtual_passbook_details.get(2).branch_name_en, result);
        result = CheckResults(elAccountName4, fundName4, result);
        result = CheckResults(elBalance4, response.getData().virtual_passbook_details.get(3).branch_name_en, result);
        result = CheckResults(elAccountName5, fundName5, result);
        result = CheckResults(elBalance5, response.getData().virtual_passbook_details.get(4).branch_name_en, result);
        result = CheckResults(elAccountName6, fundName6, result);
        result = CheckResults(elBalance6, response.getData().virtual_passbook_details.get(5).branch_name_en, result);
        result = CheckResults(elAccountName7, fundName7, result);
        result = CheckResults(elBalance7, response.getData().virtual_passbook_details.get(6).branch_name_en, result);
        ...
        Assert.assertTrue(elBalance1.equals(response.getData().virtual_passbook_details.get(0).branch_name_en));
        Assert.assertTrue(elAccountName2.equals(fundName2));
        Assert.assertTrue(elBalance2.equals(response.getData().virtual_passbook_details.get(1).branch_name_en));
        Assert.assertTrue(elAccountName3.equals(fundName3));
        Assert.assertTrue(elBalance3.equals(response.getData().virtual_passbook_details.get(2).branch_name_en));
        Assert.assertTrue(elAccountName4.equals(fundName4));
        Assert.assertTrue(elBalance4.equals(response.getData().virtual_passbook_details.get(3).branch_name_en));
        Assert.assertTrue(elAccountName5.equals(fundName5));
        Assert.assertTrue(elBalance5.equals(response.getData().virtual_passbook_details.get(4).branch_name_en));
        Assert.assertTrue(elAccountName6.equals(fundName6));
        Assert.assertTrue(elBalance6.equals(response.getData().virtual_passbook_details.get(5).branch_name_en));
        Assert.assertTrue(elAccountName7.equals(fundName7));
        Assert.assertTrue(elBalance7.equals(response.getData().virtual_passbook_details.get(6).branch_name_en));
    ...
    public void TC_ONEAPP_10582_PBMF_00001() throws Exception {
        ...
        Assert.assertTrue(elVirtualPassbook.equals("Passbook Cover"));
