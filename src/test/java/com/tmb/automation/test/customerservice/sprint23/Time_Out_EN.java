...
public class Time_Out_EN extends Base {
    ...
    public void TC_ONEAPP_8852_NDID_EN_REQ_SIT_01004() throws Exception {
        ...
        String Expected_date = expectedValue.plus(40, ChronoUnit.SECONDS).toString();
    ...
    public void TC_ONEAPP_8852_NDID_EN_REQ_SIT_01005() throws Exception {
        ...
        Assert.assertTrue(elTitleTimeout.equals("Request has timed out"));
        Assert.assertTrue(elTimeoutDetail.equals("This authentication request has timed out. Please make a new request "));
        Assert.assertTrue(elTransactionTimeout.substring(0, elTransactionTimeout.length() - 8).equals("Transaction Date" + DateTimeNow + "Ref. No"));
        Assert.assertTrue(elBtnBackToMianMenu.equals("Back to Main Menu"));
    }
}
