...
public class TC_ONEAPP_4521_TH  extends Base {
    ...
    @Test(priority = 0)
    public void TC_ONEAPP_4521_EN_CSTTutorial_SIT_00001() throws Exception {
        OpenService();
        ...
        MobileElement TutorialTitle = (MobileElement) com.tmb.automation.test.customerservice.sprint17.Base.driver.findElementByXPath("//*[@resource-id='label_customerservice_case_tracking_title_tutorial']");
        String elTutorialTitle = TutorialTitle.getText();
        MobileElement TutorialDetail = (MobileElement) com.tmb.automation.test.customerservice.sprint17.Base.driver.findElementByXPath("//*[@resource-id='label_customerservice_case_tracking_desc_tutorial']");
        ...
        System.err.println("get element : " + elTutorialDetail);
              ...
              Assert.assertTrue(elTutorialTitle.equals("ติดตามสถานะคำขอ/คำร้อง"));
        Assert.assertTrue(elTutorialDetail.equals("ให้คุณได้ติดตามความคืบหน้าในการขอใช้บริการต่างๆ ของทีทีบีได้อย่างใกล้ชิด ทุกที่ ทุกเวลา"));
    }

    @Test(priority = 1)
    public void TC_ONEAPP_4521_EN_CSTTutorial_SIT_00002() throws Exception {
        WebDriverWait wait = new WebDriverWait(com.tmb.automation.test.customerservice.sprint17.Base.driver, 40);
        MobileElement btnStart = com.tmb.automation.test.customerservice.sprint17.Base.driver.findElement(By.xpath("//*[@resource-id='button_customerservice_case_tracking_start_tutorial']"));
        btnStart.click();
