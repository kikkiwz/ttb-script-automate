...
public class API_TC14_ActivityLogNDIDConsent extends Base {
...
//ekYC Activity Log ----------------------------------------------------
		...
		String Input1 = "Step (9/16) : eKYC - NDID Consent";
		String Input2 = "Y / N";
		String Input3 = "1.01";
		...
		hmC1.put("ndid_flag", Input2);
		hmC1.put("tc_ndid_version", Input3);
...
//Verify in ccweb ------------------------------------------------------------------
		...
		Assert.assertEquals(Details1a, "Step (9/16) = "+Input1);
		Assert.assertEquals(Details1b, "T&C of NDID = "+Input2);
		Assert.assertEquals(Details1c, "T&C of NDID version = "+Input3);
