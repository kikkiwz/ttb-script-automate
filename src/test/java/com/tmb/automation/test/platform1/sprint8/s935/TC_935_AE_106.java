...
public class TC_935_AE_106 extends Base {
	...
	public void ADTest001() throws IOException {
		...
		hs.assertText(hs.fX(hs.saLbHS_TextShow).getText(), map("Text1"));
		hs.EnterPin("010204");
		sleep();
		hs.waitVisible(hs.saLbHS_TextShow);
		hs.assertText(hs.fX(hs.saLbHS_TextShow).getText(), map("Text2"));
		hs.EnterPin("010203");
		sleep();
		hs.setWebview();
