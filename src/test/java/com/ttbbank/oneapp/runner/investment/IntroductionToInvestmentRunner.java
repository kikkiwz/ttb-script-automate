...
import com.ttbbank.oneapp.scenario.investment.AccountScenario;
import com.ttbbank.oneapp.scenario.investment.IntroductionToInvestmentScenario;
...
public class IntroductionToInvestmentRunner extends IntroductionToInvestmentScenario {
    ...
    public void BeforeTest(@Optional String deviceProfile) throws MalformedURLException {
        ...
        ExtentTest feature = extentReports.createTest("Introduction To Investment");
        setFeature(feature);
