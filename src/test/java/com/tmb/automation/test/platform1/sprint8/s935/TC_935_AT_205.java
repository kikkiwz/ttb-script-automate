...
public class TC_935_AT_205 extends Base {
	...
	public void ADTest001() throws IOException {
		...
		hs.assertText(hs.fX(hs.saLbHS_EnterYourPin).getText()
				, map("Text1_TH"));
		hs.click(hs.fX(hs.saBtnHS_PinClose));
		sleep();
		...
		hs.waitVisible(hs.saLbHS_EnterYourPin);
		hs.EnterPin("123");
		hs.assertTrue(hs.saBtnHS_PinClear);
		hs.click(hs.saBtnHS_PinClose);
		...
		hs.waitVisible(hs.saLbHS_EnterYourPin);
		hs.EnterPin("123");
		hs.assertText(hs.fX(hs.saBtnHS_ForgetPIN).getText(), map("Text3_TH"));
		hs.click(hs.saBtnHS_PinClose);
		...
		sleep();
		hs.setNative();
		hs.waitVisible(hs.saBtnHS_ForgetPIN);
