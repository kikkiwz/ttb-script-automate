...
public class TC_ONEAPP_4515_EN extends Base {
    ...
    @Test(priority = 0)
    public void TS_ONEAPP_4515_EN_NoAST_SIT_00001() throws Exception {
        OpenService();
        ...
        System.err.println("get element : " + elSectionInprogress);
               ...
               Assert.assertTrue(elCaseStatusTrackingHeader.equals("Application Tracking"));
        Assert.assertTrue(elSectionInprogress.equals("empty"));
    }
}
