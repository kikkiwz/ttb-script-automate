...
import com.ttbbank.oneapp.scenario.investment.FundFactSheetFromFundInfoTestScenario;
import com.ttbbank.oneapp.scenario.investment.FundInformationFromSearchFundTestScenario;
...
public class FundFactSheetFromFundInfoRunner extends FundFactSheetFromFundInfoTestScenario {
    ...
    public void BeforeTest(@Optional String deviceProfile) throws MalformedURLException {
        ...
        ExtentTest feature = extentReports.createTest("Fund Fact Sheet come from Fund Information Page");
        setFeature(feature);
