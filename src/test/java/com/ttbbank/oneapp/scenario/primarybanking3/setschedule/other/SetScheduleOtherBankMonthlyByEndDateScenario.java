...
public class SetScheduleOtherBankMonthlyByEndDateScenario extends PrimaryBanking3Base {
    ...
    @Test(groups = "Set schedule other bank monthly end date", priority = 1)
    ...
    @Test(groups = "Set schedule other bank monthly end date", priority = 2)
    ...
    @Test(groups = "Set schedule other bank monthly end date", priority = 3)
    public void testFilledSetscheduleEnterDetailAndNextToReviewScreenSuccess() throws IOException {
        ...
        context.findElement(OneAppElementKeys.PB3_SET_SCHEDULE_END_DATE_MONTHLY_OTHER).click();
        context.findElement(OneAppElementKeys.PB3_KEYPAD_DONE).click();
        scheduleEndDate = context.findElement(OneAppElementKeys.PB3_SET_SCHEDULE_END_DATE_MONTHLY_OTHER).getText();
    ...
    @Test(groups = "Set schedule other bank monthly end date", priority = 4)
    ...
    @Test(groups = "Set schedule other bank monthly end date", priority = 5)
