...
public class KYC_AfterLogin_Flag_I_Scenario extends BaseScenario {
	TtbTestContext context;
	public static ExtentTest Scenario1;
	public static String Environment="DEV";
	public static String ACTIVITY_LOG_URL;

    @Test(groups = "KYC verify after login with flag I")
    public void KYC_Review_AfterLogin_FLAG_I() throws InterruptedException, IOException {
		...
		try {
			...
			String Image = "images/IT4IT/KYCI/logged_in_"+new SimpleDateFormat("HHmmss").format(new Date())+".png";
		...
		try {
			...
			String Image = "images/IT4IT/KYCI/Register_"+new SimpleDateFormat("HHmmss").format(new Date())+".png";
			takeScreenshot(Image);
		...
		try {
			...
			String Image = "images/IT4IT/KYCI/App_Tutorial"+new SimpleDateFormat("HHmmss").format(new Date())+".png";
			takeScreenshot(Image);
...
try {
		...
		String Image = "images/IT4IT/KYCI/KYC_I_PAGE"+new SimpleDateFormat("HHmmss").format(new Date())+".png";
		takeScreenshot(Image);
	...
	Scenario1.createNode(Given.class, "After Clicking on setting tab KYC page not loaded").addScreenCaptureFromPath(Image).fail(t);			
		...
		confirmPin();
		Thread.sleep(2000);
		Activity_log("001100000000000000000012189005","100000100","Verify Current PIN","Success"," KYC_VERIFY_PIN_STATUS",0,Scenario1);
		...
		String Image = "images/IT4IT/KYCI/KYC_I_"+new SimpleDateFormat("HHmmss").format(new Date())+".png";
		takeScreenshot(Image);
		Scenario1.createNode(Given.class, "Personal Information page inside KYC page successfully loaded for CRM ID set to flag I").addScreenCaptureFromPath(Image).pass("PASS");			

	}
catch(Throwable t) {
	String Image = "images/IT4IT/KYCI/KYC_B_"+new SimpleDateFormat("HHmmss").format(new Date())+".png";
	takeScreenshot(Image);
	Scenario1.createNode(Given.class, "Unable to load Personal Information page for CRM ID set to flag I").addScreenCaptureFromPath(Image).fail(t);			
}
