...
public class SetScheduleOtherBankWeeklyByEndDateScenario extends PrimaryBanking3Base {
    ...
    @Test(groups = "Set schedule other bank weekly end date", priority = 1)
    ...
    @Test(groups = "Set schedule other bank weekly end date", priority = 2)
    ...
    @Test(groups = "Set schedule other bank weekly end date", priority = 3)
    public void testFilledSetscheduleEnterDetailAndNextToReviewScreenSuccess() throws IOException {
        ...
        context.findElement(OneAppElementKeys.PB3_OTHER_TRANSFER_SELECT_BANK_SCB).click();
        ...
        context.findElement(OneAppElementKeys.PB3_KEYPAD_DONE).click();
        scheduleStartDate = context.findElement(OneAppElementKeys.PB3_SET_SCHEDULE_START_DATE_OTHER).getText();

        context.findElement(OneAppElementKeys.PB3_SCHEDULE_FREQUENCY_WEEKLY_RADIO).click();

        context.findElement(OneAppElementKeys.PB3_SET_SCHEDULE_END_DATE_OTHER).click();
        context.findElement(OneAppElementKeys.PB3_KEYPAD_DONE).click();
        scheduleEndDate = context.findElement(OneAppElementKeys.PB3_SET_SCHEDULE_END_DATE_OTHER).getText();
    ...
    @Test(groups = "Set schedule other bank weekly end date", priority = 4)
    public void testDataAssertEqualsEnterDetailsOnReviewScreenAndTapOnConfirm() throws IOException {
        ...
        evaluateAssertEqual(
                context.findElementByAccessibilityId("111-3-92689-0").getText(),
                toAccountNumber,
    ...
    @Test(groups = "Set schedule other bank weekly end date", priority = 5)
