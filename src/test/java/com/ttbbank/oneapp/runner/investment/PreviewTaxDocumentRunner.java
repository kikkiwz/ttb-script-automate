...
import com.ttbbank.oneapp.scenario.investment.PreviewTaxDocumentTestScenario;
...
public class PreviewTaxDocumentRunner extends PreviewTaxDocumentTestScenario {
    ...
    public void BeforeTest(@Optional String deviceProfile) throws MalformedURLException {
        ...
        ExtentTest feature = extentReports.createTest("Tax Document and Tax Summary");
        setFeature(feature);
