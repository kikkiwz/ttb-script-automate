...
public class TC_935_IT_406 extends Base {
	...
	public void ADTest001() throws IOException {
		...
		hs.assertText(hs.fX(hs.siLbHS_TextShow).getText(), map("Text1_TH"));
		hs.EnterPin("010204");
		sleep();
		hs.waitVisible(hs.siLbHS_TextShow);
		hs.assertText(hs.fX(hs.siLbHS_TextShow).getText(), map("Text2_TH"));
		hs.EnterPin("010203");
		sleep();
		hs.setWebview();
