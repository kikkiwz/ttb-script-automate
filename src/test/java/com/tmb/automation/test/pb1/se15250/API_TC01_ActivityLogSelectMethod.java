...
public class API_TC01_ActivityLogSelectMethod extends Base {
...
//ekYC Activity Log ----------------------------------------------------
		...
		String Input1 = "Step (8/16) : eKYC - Select Method";
		String Input2 = "Mobile Banking";
...
//Verify in ccweb ------------------------------------------------------------------
		...
		Assert.assertEquals(Details1a, "Step (8/16) = "+Input1);
		Assert.assertEquals(Details1b, "Verify Method = "+Input2);
	
		System.out.println("///////////ActivityLog CCWeb Success/////////////// ");
	}
