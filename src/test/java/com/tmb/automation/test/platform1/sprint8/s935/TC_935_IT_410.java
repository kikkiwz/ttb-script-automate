...
public class TC_935_IT_410 extends Base {
	...
	public void ADTest001() throws IOException {
		...
		hs.assertTrue(hs.siLbHS_EnterYourPin);
...
//		Helper.writeLog(appiumDriver.getPageSource());
		...
		hs.assertText(hs.fX(hs.swLbHS_AccountName).getText(), map("AccountName_android_TH"));
