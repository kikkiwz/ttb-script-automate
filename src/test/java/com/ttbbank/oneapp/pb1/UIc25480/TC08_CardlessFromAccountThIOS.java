...
public class TC08_CardlessFromAccountThIOS extends BaseScenario {
	...
	@Test(groups = {"ios", "PB1"}, description="CardlessFromAccount IOS")
...
//		enterPin();
		...
		String EnterAmountError1 = ttbTestContext.findElement(OneAppElementKeys.PB1_CARDLESS_FIELD_HELP_TEXT1).getText();
		...
		String EnterAmountError2 = ttbTestContext.findElement(OneAppElementKeys.PB1_CARDLESS_FIELD_HELP_TEXT1).getText();
		...
		String EnterAmountError3 = ttbTestContext.findElement(OneAppElementKeys.PB1_CARDLESS_FIELD_HELP_TEXT1).getText();
