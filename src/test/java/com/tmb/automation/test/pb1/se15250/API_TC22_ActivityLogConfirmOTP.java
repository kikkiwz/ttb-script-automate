...
public class API_TC22_ActivityLogConfirmOTP extends Base {
	...
	@Test(groups = {"android", "PB1"}, description="ActivityLog ConfirmOTP Pass")
	public void TC01_ConfirmOTPPass() throws InterruptedException, IOException {
...
//ekYC Activity Log ----------------------------------------------------
		...
		String step_number = "Step (7/16) : eKYC - Confirm OTP";
		String otp_ref = "123456";
		String mobile_number = "0123456789";
		String resultLog = "Success";
 
		HashMap<String, Object> hmC1 =new HashMap<>();
		hmC1.put("activity_type_id", activity_type);
		hmC1.put("activity_status", activity_status);
		hmC1.put("fail_reason", fail_reason);
		hmC1.put("step_number", step_number);
		hmC1.put("otp_ref", otp_ref);
		hmC1.put("mobile_number", mobile_number);
		hmC1.put("result", resultLog);
...
//Verify in ccweb ------------------------------------------------------------------
		...
		OpenReport.reportString("Login Status2 is "+statusString2);
		...
		Assert.assertEquals(Details1a, "Step (7/16) = "+step_number);
		Assert.assertEquals(Details1b, "OTP Ref  = "+otp_ref);
		Assert.assertEquals(Details1c, "Mobile Number = "+mobile_number);
		Assert.assertEquals(Details1d, "Result = "+resultLog);

		System.out.println("///////////ActivityLog Success/////////////// ");
	}

	
	@Test(groups = {"android", "PB1"}, description="ActivityLog ConfirmOTP Fail")
	public void TC02_ConfirmOTPFail() throws InterruptedException, IOException {
		log("------------Start "+this.getClass().getSimpleName());
...
//ekYC Activity Log ----------------------------------------------------
		String ActivityLog = ApiUrlEKYC.ActivityLog;
		System.out.println("////////ActivityLog///////////-  " +"\n" +ActivityLog);
		String activity_status = "failure";
		String fail_reason = "FailReason";
		String step_number = "Step (7/16) : eKYC - Confirm OTP";
		String otp_ref = "123456";
		String mobile_number = "0123456789";
		String resultLog = "Failure";
...
//Verify in ccweb ------------------------------------------------------------------
		...
		String result = jo3.getString("result");
		String activity_detail = jo3.getString("activity_detail");
		String fail_reason1 = jo3.getString("reason");
		System.out.println("/////////////result//////////- " + result);
		Assert.assertEquals(result, resultLog);
		Assert.assertEquals(fail_reason1, fail_reason);
