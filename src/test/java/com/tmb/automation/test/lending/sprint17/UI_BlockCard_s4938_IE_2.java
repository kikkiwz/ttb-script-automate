...
public class UI_BlockCard_s4938_IE_2 extends Base {
	...
	public void ADTest001() throws IOException {
		...
		ld.assertContain(ld.fX(ld.swLbBC_Desc2).getText(), mapData.get("Desc2"));
		ld.assertContain(ld.fX(ld.swLbBC_Desc3).getText(), mapData.get("Desc3"));
