...
public class TC_937_AT_203 extends Base {
...
//		sleep(0.5);
		...
		sleep();
		ver.setText2(hs.fX(ver.swTxtVerifyEmail_Email), map("Value1_TH"));
		hs.assertText(hs.fX(ver.swTxtVerifyEmail_Email).getAttribute("value"), map("Value1_TH"));
		...
		hs.fX(ver.swTxtVerifyEmail_Email).clear();
		sleep();
		ver.setText2(ver.fX(ver.swTxtVerifyEmail_Email), map("Value2_TH"));
		hs.click(hs.fX(ver.swBtnVerifyEmail_VerifyEmail));
		hs.assertText(hs.fX(ver.swLbVerifyEmail_EmailErrorMsg).getText(), map("MSG_01_TH"));
		...
		hs.fX(ver.swTxtVerifyEmail_Email).clear();
		sleep();
		ver.setText2(ver.fX(ver.swTxtVerifyEmail_Email), map("Value3_TH"));
		hs.click(hs.fX(ver.swBtnVerifyEmail_VerifyEmail));
		hs.assertText(hs.fX(ver.swLbVerifyEmail_EmailErrorMsg).getText(), map("MSG_02_TH"));
		
		log("TC_OneApp_MB_POC_Verify Email EN_SIT_00021	\"Validate screen if enter email does not exist");
		hs.fX(ver.swTxtVerifyEmail_Email).clear();
		sleep();
		ver.setText2(ver.fX(ver.swTxtVerifyEmail_Email), map("Value4_TH"));
		hs.click(hs.fX(ver.swBtnVerifyEmail_VerifyEmail));
		hs.assertText(hs.fX(ver.swLbVerifyEmail_EmailErrorMsg).getText(), map("MSG_03_TH"));
	}
}
