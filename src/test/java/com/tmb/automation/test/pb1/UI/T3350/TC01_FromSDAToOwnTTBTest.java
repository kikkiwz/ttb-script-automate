...
public class TC01_FromSDAToOwnTTBTest extends Base {
	...
	@Test(groups = {"android", "PB1"}, description="TransferFromSDAToOwnTTBTest")
	public void Test001  () throws InterruptedException, IOException{
		...
		action.press(PointOption.point(1000, 600))
		...
		action.press(PointOption.point(200, 950))
		.waitAction(WaitOptions.waitOptions(Duration.ofSeconds(2)))
		.moveTo(PointOption.point(200, 650)).release().perform();
